    ...
    private  class FreezeGoogleServicesTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                if (isLeoAvilible(mContext, "com.google.android.configupdater")) {
                    pm.setApplicationEnabledSetting("com.google.android.configupdater", i, 0);
                }
                if (isLeoAvilible(mContext, "com.google.android.feedback")) {
                    pm.setApplicationEnabledSetting("com.google.android.feedback", i, 0);
                }
                if (isLeoAvilible(mContext, "com.google.android.onetimeinitializer")) {
                    pm.setApplicationEnabledSetting("com.google.android.onetimeinitializer", i, 0);
                }
