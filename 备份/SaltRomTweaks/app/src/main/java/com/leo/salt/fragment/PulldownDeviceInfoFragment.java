...
public class PulldownDeviceInfoFragment extends BasePreferenceFragment implements
    ...
    private SaltSettingSeekBarPreference mSize,mList;
    ...
    private SaltSettingDefaultListPreference mOne,mTwo,mThree,mFour,mFive,mEnabled;
    @Override
    public void onCreate(Bundle savedInstanceState ) {
        ...
        mList= (SaltSettingSeekBarPreference) findPreference("InfoList");
        int List = Settings.System.getInt(resolver,
                KEY8, 1);
        mList.setValue(List);
    ...
    private void setChinaTime() {
        int mNavRingLong = Settings.System.getInt(getActivity().getContentResolver(),
                KEY8, 1);
        if (mNavRingLong==1) {
            ...
            mFour.setEnabled(false);
            mFive.setEnabled(false);
        }else  if (mNavRingLong==3){
            mOne.setEnabled(true);
            mTwo.setEnabled(true);
            mThree.setEnabled(true);
            mFour.setEnabled(false);
            mFive.setEnabled(false);
        }else  if (mNavRingLong==4){
            mOne.setEnabled(true);
            mTwo.setEnabled(true);
            mThree.setEnabled(true);
            mFour.setEnabled(true);
            mFive.setEnabled(false);
        }else  if (mNavRingLong==5){
            mOne.setEnabled(true);
            mTwo.setEnabled(true);
            mThree.setEnabled(true);
            mFour.setEnabled(true);
