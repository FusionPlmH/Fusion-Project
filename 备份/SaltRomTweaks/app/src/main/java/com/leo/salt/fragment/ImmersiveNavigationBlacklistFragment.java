...
public class ImmersiveNavigationBlacklistFragment  extends BasePreferenceFragment implements Preference.OnPreferenceClickListener {

    private static final String TAG = "Blacklist";
    private static final String KEY_BLACKLIST = "add_nav_blacklist_packages";
    ...
    protected void initializeAllPreferences() {
        BasePreferenceFragment( mContext , this, "immersive_nav_whitelist_prefs");
        mBlacklistPackageStore ="leo_salt_hidenavigation_whitelist";
