...
public class ColorPickerPreference
    ...
    private static final String leo = "http://schemas.android.com/apk/res/com.tweaks.leo";

    private void init(Context context, AttributeSet attrs) {
        mDensity = getContext().getResources().getDisplayMetrics().density;
        setOnPreferenceClickListener(this);
        if (attrs != null) {
            String defaultValue = attrs.getAttributeValue(leo, "defaultColor");
            if (defaultValue.startsWith("#")) {
                ...
                int resourceId = attrs.getAttributeResourceValue(leo, "defaultColor", 0);
                if (resourceId != 0) {
                    this.mDefaultValue = context.getResources().getColor(resourceId);
                }
            }
    ...
    private void showDialog(Bundle state) {
        mDialog = new ColorPickerDialog(getContext(), mValue,mDefaultValue);
