...
public class GlobalListPreference extends ListPreference implements Preference.OnPreferenceChangeListener {
    ...
    public GlobalListPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (!restoreValue) {
            if (dbValue != null) {
                ...
                if (defaultValue != null) {
                    ...
                    Settings.Global.putString(mContentResolver, getKey(), (String) defaultValue);
                }
            }
        } else {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Settings.Global.putString(mContentResolver, getKey(), (String) newValue);
