...
public class RebootUtil {
    private static final String TAG = RebootUtil.class.getSimpleName();
   ...
   public static void performRestartTask(Context context, String action,String processNa) {
        ...
        if (action.equals(rt1001foleo("bGVvLmFjdGlvbi5TeXN0ZW1VaQ=="))) {
            restartSystemUi(context,processNa);
            return;
        }else if (action.equals(rt1001foleo("bGVvLmFjdGlvbi5yZWJvb3RTeXN0ZW0="))) {
            rebootSystem(context);
            return;
        }  else if (action.equals(rt1001foleo("bGVvLmFjdGlvbi5Eb3dubG9hZA=="))) {
            rebootDownload();
            return;
        } else if (action.equals(rt1001foleo("bGVvLmFjdGlvbi5SZWNvdmVyeQ=="))) {
            rebootRecovery();
            return;
        } else if (action.equals(rt1001foleo("bGVvLmFjdGlvbi5ob3RSZWJvb3Q="))) {
            hotReboot();
            return;
        } else if (action.equals(rt1001foleo("bGVvLmFjdGlvbi5TeXN0ZW1TaHV0ZG93bg=="))) {
