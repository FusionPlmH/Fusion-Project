...
import static com.fusionleo.LeoX.systemui.LeoConfig.getStringLeoArray;
import static com.fusionleo.LeoX.systemui.LeoConfig.rt100foleo;
import static com.fusionleo.LeoX.systemui.LeoLunar.Constant.get12solar;
import static com.fusionleo.LeoX.systemui.LeoLunar.Constant.get24solar;
import static com.fusionleo.LeoX.systemui.LeoLunar.Constant.getMailyears;
import static com.fusionleo.LeoX.systemui.LeoLunar.Constant.*;
...
public class LeoLunar {
    ...
    private String[] MailEdecylMonthName;
        public LeoLunar(Calendar cal,Context context) {
            ...
            EarthlyMonthName=getTerrestrialbranch(context);
            MailyearsMonthName=getMailyears(context);
            MailBorgMonthName=getBorg(context);
            MailEdecylMonthName=getEdecyl(context);
    ...
    static  class SolarTermsUtil {
        ...
        public SolarTermsUtil(Calendar calendar,Context context) {
            principleTermNames=get12solar(context);
            sectionalTermNames=get24solar(context);
