...
public class HomeTouchInteractor implements  OnSharedPreferenceChangeListener {
    ...
    private void LeoGestureUP(String str, boolean z) {
       Context context= mViewContext;
        LeoLauncherManages(context);
        int i=setLeoLauncherSlideGestureTopAction;
        if (setLeoLauncherSlideGestureEnabled) {

                setLeoAction(context,LauncherGesture[5],i);
    ...
    private void LeoGestureDown(String str, boolean z) {
        Context context= mViewContext;
        LeoLauncherManages(context);
        int i=setLeoLauncherSlideGestureBottomAction;
        if (setLeoLauncherSlideGestureEnabled) {

            setLeoAction(context,LauncherGesture[6],i);
