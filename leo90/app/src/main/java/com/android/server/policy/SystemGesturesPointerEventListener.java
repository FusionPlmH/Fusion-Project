...
public class SystemGesturesPointerEventListener implements PointerEventListener {
    ...
    public void setLeoGesturesKeypressAction(String Code,int style ) {
        Context context=mContext;
        setLeoKeypressAction(context,Code,style);
    }

    public void TopGestureSlide(MotionEvent event) {
        Context context = this.mContext;
        LeoSetting(context);
        if(setLeoGlobalEnableFingerGestures){
            if (event.getPointerCount() ==getGesturesFingersCount(context) ) {
                String str=setGlobalTopActionGestures;
                int style=setLeoGlobalTopActionGestures;
                setLeoGesturesKeypressAction(str,style);
                LeoHaptics(context);
            }

        }
    }
    public void LeftGestureSlide(MotionEvent event) {
        Context context = this.mContext;
        LeoSetting(context);
        if(setLeoGlobalEnableFingerGestures){
            if (event.getPointerCount() ==getGesturesFingersCount(context) ) {
                String str=setGlobalLeftActionGestures;
                int style=setLeoGlobalLeftActionGestures;
                setLeoGesturesKeypressAction(str,style);
                LeoHaptics(context);
            }
    ...
    public void RightGestureSlide(MotionEvent event) {
        Context context = this.mContext;
        LeoSetting(context);
        if(setLeoGlobalEnableFingerGestures){
            if (event.getPointerCount() ==getGesturesFingersCount(context) ) {
                String str=setGlobalRightActionGestures;
                int style=setLeoGlobalRightActionGestures;
                setLeoGesturesKeypressAction(str,style);
                LeoHaptics(context);
            }
    ...
    public void BottomGestureSlide(MotionEvent event) {
        Context context = this.mContext;
        LeoSetting(context);
        if(setLeoGlobalEnableFingerGestures){
            if (event.getPointerCount() ==getGesturesFingersCount(context) ) {
                String str=setGlobalBottomActionGestures;
                int style=setLeoGlobalBottomActionGestures;
                setLeoGesturesKeypressAction(str,style);
                LeoHaptics(context);
            }
        }
    }
    private void LeoHaptics(Context context){
        setLeoHaptics(context,setLeowGlobalFingerGesturesVibratorEnable,setLeoGlobalFingerGesturesVibratorLevel);
    }



    public int getGesturesFingersCount(Context context) {
        LeoSetting(context);
        return setLeoGlobalFingerGesturesCount;
    }
