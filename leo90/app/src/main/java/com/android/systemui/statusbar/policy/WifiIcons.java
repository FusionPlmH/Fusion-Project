...
import static com.android.systemui.util.LeoDrawable.mLeoStatusBarWifiIconStyle;
import static com.android.systemui.util.LeoDrawable.*;

public class WifiIcons {
    static final int[][] WIFI_SIGNAL_STRENGTH = mLeoStatusBarWifiIconStyle;
    ...
    static final int[] WIFI_ACTIVITY_DEFAULT = mLeoStatusBarWIFIActivity;
