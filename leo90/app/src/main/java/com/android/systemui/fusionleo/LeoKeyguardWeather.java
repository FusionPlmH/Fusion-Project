...
public class LeoKeyguardWeather  extends LinearLayout implements LeoObserver.ObListener{
    private int i;
    ...
    public void onLeoChange(String str) {
        for (String equals :KeyguardWeather) {
    ...
    public LeoKeyguardWeather(Context context,  AttributeSet attrs) {
        super(context, attrs);
        ...
        for (String uriFor :KeyguardWeather) {
