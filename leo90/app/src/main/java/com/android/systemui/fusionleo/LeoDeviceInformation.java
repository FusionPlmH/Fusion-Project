...
import static com.fusionleo.LeoX.systemui.LeoConfig.GPUTempMHZ;
import static com.fusionleo.LeoX.systemui.LeoConfig.capacityunit;
import static com.fusionleo.LeoX.systemui.LeoConfig.getAndroidSDKVersion;
import static com.fusionleo.LeoX.systemui.LeoConfig.getCurrent;
import static com.fusionleo.LeoX.systemui.LeoConfig.getGPUModel;
import static com.fusionleo.LeoX.systemui.LeoConfig.getGPUbusy;
import static com.fusionleo.LeoX.systemui.LeoConfig.getLeoFloatingFature;
import static com.fusionleo.LeoX.systemui.LeoConfig.getLeoSystemProper;
import static com.fusionleo.LeoX.systemui.LeoConfig.getNumCpuCores;
import static com.fusionleo.LeoX.systemui.LeoConfig.getVoltage;
import static com.fusionleo.LeoX.systemui.LeoConfig.isCpu64;

import static com.fusionleo.LeoX.systemui.LeoConfig.nextalarm;
...
public class LeoDeviceInformation extends LeoConfigTextView {
           public LeoDeviceInformation(Context context) {
               this(context, null);
           }
           public LeoDeviceInformation(Context context, AttributeSet attributeSet) {
               this(context, attributeSet, 0);
           }
           public LeoDeviceInformation(Context context, AttributeSet attributeSet, int level) {
             ...
             Context context=  mContext;
               ...
               switch (style) {
                   ...
                   case 5:
                       ...
                       info ="RAM:"+getTotalRam()+"/"+getSystemMemoryUsableSize()+" "+str2+":"+getTotalExternalMemorySize()+"/"+getAvailableExternalMemorySize();
                       break;
                   case 6:
           ...
           private void intInfoView(int infoStyle,int infocolor,int infofont,String str){
               ...
               info.setSpan(new LeoConfig.TypefaceFonts(setLeoFonts(getContext(), infofont,font,typ)), 0, info.length(), 33);
               append(info);
               append(str);
           }
        public void updateQSDeviceInfo() {
            LeoSysUiManages(mContext);
             if ("leo_qs_device_info_view".equals(getTag())) {
                 boolean of= setLeoDeviceInfoStatusbar;
                 if (of){
                     refresh();
                     setText(getInfoList(setLeoDeviceInfoStatusbarStyle));
                     setTextSize(  setLeoDeviceInfoStatusbarSize);
                     setLeoTextFont( setLeoDeviceInfoStatusbarFont, "sec-roboto-light",Typeface.NORMAL);
