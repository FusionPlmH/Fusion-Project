...
import static com.android.systemui.util.LeoDrawable.mLeoStatusBarMaxRssiLevel;
import static com.android.systemui.util.LeoDrawable.mLeoStatusBarSignal;
...
public class Rune {
    ...
    public static int STATBAR_MAX_SIGNAL_LEVEL = mLeoStatusBarMaxRssiLevel;
    public static String STATBAR_ICON_BRANDING =mLeoStatusBarSignal;
