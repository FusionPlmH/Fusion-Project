...
public class SecNavigationBarView extends NavigationBarView {
    ...
    public void setLeoNavBar() {
        updateNavView leoObserver = new updateNavView(new Handler());
        leoObserver.observer();
        leoObserver.NavView();
    ...
    class updateNavView extends ContentObserver {
      //  public NavBarPresenter mPresenter;

        public updateNavView(Handler handler) {
            super(handler);
        }
        ...
        public void observer() {
            ContentResolver contentResolver = SecNavigationBarView.this.getContext().getContentResolver();
            for (String leoUri : LeoManages.CustomNavBg) {
                contentResolver.registerContentObserver(LeoConfig.getLeoUri(leoUri), false, this);
            }
        }
