...
public class SaltBaseSeekPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private TextView mSeekBardefaul;
    ...
    public SaltBaseSeekPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        setLayoutResource(R.layout.seek_bar_preference);
        setValuesFromXml(attrs, context);
    }

    public SaltBaseSeekPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, LEOGEARNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, LEOGEARNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(LEOGEARNS, "interval");
            if(newInterval != null)
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        mSeekBarMax = (TextView) holder.findViewById(R.id.seekBarMax);
        mSeekBardefaul = (TextView) holder.findViewById(R.id.seekBardefaul);
    ...
    protected void updateView() {
        ...
        try {
            ...
            mSeekBarMax.setText(String.format(Locale.getDefault(), mFormat,mMaxValue,mUnitsRight));
            mSeekBardefaul.setText(String.format(Locale.getDefault(), mFormat,mMinValue,mUnitsRight));
