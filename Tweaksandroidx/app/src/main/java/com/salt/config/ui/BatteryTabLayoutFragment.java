...
import com.salt.config.tweaks.fragment.StatusBarBatteryFragment;
import com.salt.config.tweaks.fragment.StatusBarBatterybarFragment;
import com.salt.config.tweaks.fragment.StatusBarIconFragment;
import com.salt.config.tweaks.fragment.StatusBarLogoFragment;
...
public class BatteryTabLayoutFragment extends Fragment {
    ...
    private String[] getTitles() {
        ...
        titleString = new String[]{
                getApksStringInt("grid_battery"),getApksStringInt("grid_battery_bar")};
        return titleString;
    }
