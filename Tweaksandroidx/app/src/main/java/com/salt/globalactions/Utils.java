...
import static com.salt.frame.LeadFrame.getCustomArray;
import static com.salt.frame.LeadFrame.getCustomArrayDrawable;
...
public class Utils  {
    ...
    public static  void PowerMenuActionSimplify(Activity context, int Style, boolean z){
        switch (Style) {
            case 0:// 关机
                if(z){
                    ...
                    ConfirmationDialog(context,getCustomArrayDrawable(context,"android","tw_ic_do_poweroff"),
                            getStringIdentifier(context,"confi_rmthe_choice_title")+getStringIdentifier(context,"confirm_choice_shutdown")+"?",
                            2006);
                }
                break;
            case 1:// 重新启动
                ...
                if(z){
                    ...
                    ConfirmationDialog(context,getCustomArrayDrawable(context,"android","tw_ic_do_restart"),
                            getStringIdentifier(context,"confi_rmthe_choice_title")+getStringIdentifier(context,"confirm_choice_restart")+"?",
                            S10reboot());
                }
                break;
            case 2:// 快速重启
                if(z){
                    ...
                    ConfirmationDialog(context,getCustomDrawable(context,"tw_leo_quickboot"),
                            getStringIdentifier(context,"confi_rmthe_choice_title")+getStringIdentifier(context,"confirm_choice_quickboot")+"?",
                            2005);
                }
            ...
            case 3:// 线刷模式
                if(z){
                    ...
                    ConfirmationDialog(context, getCustomDrawable(context,"tw_leo_download"),
                            getStringIdentifier(context,"confi_rmthe_choice_message")+getStringIdentifier(context,"confirm_choice_download")+"?",
                            2003);
                }
                break;
            case 4:// 卡刷模式
                if (Phonebootloader(3).equals("G97")) {
                    ...
                    if(z){
                        ...
                        ConfirmationDialog(context,getCustomDrawable(context,"tw_leo_recovery"),
                                getStringIdentifier(context,"confi_rmthe_choice_message")+getStringIdentifier(context,"confirm_choice_rec")+"?",
                                2004);
                    }
                }
  ...
  public   static int S10reboot(){
    ...
    public static  void PowerMenuAction(Activity context, int Style, boolean z){
        switch (Style) {
            ...
            case 4:// 卡刷模式
                ...
                break;
            case 5:// 重启UI
                showrestartDialog(context,"com.android.systemui");
                break;
            case 6:// 移动数据
                setLeoNavKeypressAction(context,233);
              //  context. finish();
    ...
    public static void screenshot(final Activity context){
        AlertDialog dialog = new AlertDialog.Builder(new ContextThemeWrapper(context, R.style.DialogStyleLight))
                .setTitle(getStringIdentifier(context,"screenshot_title"))//设置对话框的标题
                .setItems(getCustomArray(context,"screenshot_style_values"), (dialog1, which) -> {
    ...
    static void ConfirmationDialog(Context context, Drawable drawable, String str, int style){
        ...
        mLayout.setPaddingRelative(0,60,0,60);
        ...
        alert.setPositiveButton(android.R.string.ok, (dialog, which) -> setLeoNavKeypressAction(context,style));
    ...
    public static void showrestartDialog(final Context a,String packageNameToKill) {
    ...
    private static class RestartSystemUITask extends AsyncTask<Context, Void, Void> {
        ...
        protected Void doInBackground(Context... params) {
            try {
                Intent intent = new Intent();
                intent.setAction("com.salt.global.action");
    ...
    public static Drawable appICON(Context context,String string){
    ...
    public static void patcS10(Activity context){
        AlertDialog.Builder alert = new AlertDialog.Builder(context);
        alert .setTitle(FloatingFature("SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME")+"进入TWRP方法")
                .setMessage("在手机重启的同时按住\n[音量+键-Bixby键-电源键]三键同时按住\n直至进入TWRP界面松开即可\n\n如果你已经明白点击[确定]开始执行")
