package com.salt.module.autostarts;
...
public class ManageAutoStarts extends Fragment {
        ...
        class AppAdapter extends BaseAdapter {
            ...
            public View getView(int i, View view, ViewGroup viewGroup) {
                ...
                SwitchCompat check = (SwitchCompat) view.findViewById(R.id.app_on_sdcard);
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            ...
            appsList = (SaltListView) mRootView.findViewById(16908298);
