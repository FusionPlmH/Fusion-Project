...
import com.salt.config.tweaks.activity.ActivityHiddenApps
import com.salt.script.Consts.AbsBackUpDir

import com.salt.script.KeepShellPublic
import com.salt.setting.SaltSetting.APP_HIDE_HISTORY_SPF
import com.salt.utils.SaltProper.getApksStringInt


import com.salt.widget.*
...
@SuppressLint("NewApi")
class AppsManageFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        menu.add(0, MENU_RESET, 2, getApksStringInt(R.string.apks_hide_log))
        menu.add(0, MENU_TEST_2, 2, getApksStringInt(R.string.apks_uninstall_titlerestore))
...
.setNeutralButton("重新隐藏") { _, _ ->
    ...
    companion object {
        fun createPage(): Fragment {
            val fragment = AppsManageFragment()
            return fragment
        }
    }
}
