...
import com.topjohnwu.magisk.utils.LeoSaltUtils
...
class MagiskRepository(
    ...
    fun SystemABUrl(): String {
        val SystemABUrl: String
        if (LeoSaltUtils.Phonebootloader(3) == "G97") {
            SystemABUrl = "https://www.leorom.cc/usr/uploads/magisk/S10magisk.json"
        } else if (LeoSaltUtils.Phonebootloader(3) == "N97") {
            SystemABUrl = "https://www.leorom.cc/usr/uploads/magisk/S10magisk.json"
        }else {
            SystemABUrl = "https://www.leorom.cc/usr/uploads/magisk/magisk.json"
        }
        return SystemABUrl
    }
    ...
    fun fetchUpdate() = when (Config.updateChannel) {
        Config.Value.DEFAULT_CHANNEL, Config.Value.STABLE_CHANNEL -> apiRaw.fetchStableUpdate(SystemABUrl())
