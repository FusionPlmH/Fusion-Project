...
public class CustomDependencyHelper {
    ...
    LeoSaltPreferenceScreen.CustomDependencyListener mListener;
    ...
    public CustomDependencyHelper(LeoSaltPreferenceScreen.CustomDependencyListener listener, String rule, String separator){
   ...
   public  LeoSaltPreferenceScreen.CustomDependencyListener get_listener(){
       return mListener;
   }
