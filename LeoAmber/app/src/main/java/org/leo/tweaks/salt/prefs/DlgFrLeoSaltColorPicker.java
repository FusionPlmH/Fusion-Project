...
import com.LeoSalt.settings.LeoSaltSettingsActivity;
import com.LeoSalt.settings.R;
import com.LeoSalt.settings.act.LeoSaltImagePicker;
...
public class DlgFrLeoSaltColorPicker extends DialogFragment implements
        DlgFrColorPalette.onColorAutoListener

{

    private OnLeoSaltColorPickerListener mCallBack;
    ...
    public DlgFrLeoSaltColorPicker(){}

    public interface OnLeoSaltColorPickerListener{
        void onLeoSaltColorSet(int color);
    }

    public static DlgFrLeoSaltColorPicker newInstance(OnLeoSaltColorPickerListener callback, String helperfragment, String title, String key, int initialcolor, int style, boolean alphaslider, boolean auto, boolean saveonfly){
        DlgFrLeoSaltColorPicker ret = new DlgFrLeoSaltColorPicker();
        ret.ini_picker(callback, helperfragment, title,key,initialcolor, style,alphaslider, auto, saveonfly);
        return ret;
    }

    private void ini_picker(OnLeoSaltColorPickerListener callback, String helperfragment,  String title, String key, int initialcolor, int style, boolean alphaslider, boolean auto, boolean saveonfly){
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        if(mCallBack==null) {
            if(mHelperFragmentName.equals(Common.TAG_PREFSSCREEN_FRAGMENT)){
                ...
                mCallBack=(DlgFrLeoSaltColorPicker.OnLeoSaltColorPickerListener) prefsScreen.findAndGetCallBack(mKey);
            }else mCallBack=(DlgFrLeoSaltColorPicker.OnLeoSaltColorPickerListener) getFragmentManager().findFragmentByTag(mHelperFragmentName);
        }
    }
        ...
        if(pickerStyle!=2){/**** QF DIALOG *****/
            ...
            builder.setTitle(mTitle)
                    ...
                    .setPositiveButton(R.string.LeoSalts_ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if(mCallBack!=null) {
                                mCallBack.onLeoSaltColorSet(mQFcolorPickerView.getSelectedColor());
                            }
                        }
                    });
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if((getTag()!=null && !getTag().isEmpty())){
                                    LeoSaltSettingsActivity LeoSaltSettingsActivity = (LeoSaltSettingsActivity) getActivity();
                                    Intent intent = new Intent(LeoSaltSettingsActivity, LeoSaltImagePicker.class);
                                    intent.putExtra(Common.TAG_DEST_FRAGMENT_NAME_EXTRA_KEY,getTag());
                                    intent = LeoSaltImageHelper.intent_img_crop_circular(intent);
                                    LeoSaltSettingsActivity.do_fragment_gallery_image_picker(intent);
                                }
                            }
                        });
                    }
            ...
            builder.setTitle(mTitle)
                    ...
                    .setPositiveButton(R.string.LeoSalts_ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if(mCallBack!=null) {
                                mCallBack.onLeoSaltColorSet(mSMNewColorView.getColor());
                            }
                        }
                    });
            if(showAutoButton) builder.setNeutralButton("Auto",null);
                ...
                ad.setOnShowListener(new DialogInterface.OnShowListener() {
                    ...
                    public void onShow(DialogInterface dialog) {
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if((getTag()!=null && !getTag().isEmpty())){
                                    LeoSaltSettingsActivity activity = (LeoSaltSettingsActivity) getActivity();
                                    Intent intent = new Intent(activity, LeoSaltImagePicker.class);
                                    intent.putExtra(Common.TAG_DEST_FRAGMENT_NAME_EXTRA_KEY,getTag());
                                    intent = LeoSaltImageHelper.intent_img_crop_circular(intent);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        String sFile = data.getStringExtra(LeoSaltImagePicker.S_DIR_IMG);

        if(sFile!=null) {
            DlgFrColorPalette dlg_palette = DlgFrColorPalette.newInstance(Common.TAG_DLGFRLeoSaltCOLORPICKER, sFile);
    ...
    private View getQFcolorPickerView(){
        ...
        mQFcolorPickerView.addOnColorChangedListener(new OnColorChangedListener() {
            ...
            public void onColorChanged(int selectedColor) {
                ...
                if(mSaveOnFly) {
                    if(mCallBack!=null) mCallBack.onLeoSaltColorSet(selectedColor);
                }
            }
        });
    ...
    //    mSMColorPicker.setColor(mCurrentColor, callback);
        ...
        if(mSaveOnFly){
            if(mCallBack!=null){
                mCallBack.onLeoSaltColorSet(mCurrentColor);
            }
        }
    }
