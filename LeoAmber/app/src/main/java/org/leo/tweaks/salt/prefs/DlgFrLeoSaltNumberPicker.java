...
public class DlgFrLeoSaltNumberPicker extends DialogFragment {
    ...
    int mValue;
    String mUnits;
    private OnLeoSaltNumberPickerSetListener mCallback;
    NumberPicker numberPicker;

    public DlgFrLeoSaltNumberPicker(){}

    public static DlgFrLeoSaltNumberPicker newInstance(OnLeoSaltNumberPickerSetListener callback, String key, String title, int value, int min_value, int max_value, String units, String callback_fragment_finder_name){

        DlgFrLeoSaltNumberPicker ret = new DlgFrLeoSaltNumberPicker();
        String aux_key="";
    ...
    private void iniCallback(OnLeoSaltNumberPickerSetListener callback){
        mCallback=callback;
    }

    public interface OnLeoSaltNumberPickerSetListener{
        void onLeoSaltNumberPickerSet(int value, String key);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        if(mCallback==null) {
            if(mHelperFragmentName.equals(Common.TAG_PREFSSCREEN_FRAGMENT)){
                ...
                mCallback=(DlgFrLeoSaltNumberPicker.OnLeoSaltNumberPickerSetListener) prefsScreen.findAndGetCallBack(mkey);

            }else mCallback=(DlgFrLeoSaltNumberPicker.OnLeoSaltNumberPickerSetListener) getFragmentManager().findFragmentByTag(mHelperFragmentName);
        }
    }
        ...
        AlertDialog dlg = new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(R.string.LeoSalts_ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(mCallback!=null) {
                            mValue = numberPicker.getValue();
                            mCallback.onLeoSaltNumberPickerSet(mValue,mkey);
                        }
                    }
                })
                .create();
