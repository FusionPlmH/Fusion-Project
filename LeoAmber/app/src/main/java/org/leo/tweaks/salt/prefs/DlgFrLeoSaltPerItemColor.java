...
public class DlgFrLeoSaltPerItemColor extends DialogFragment
        implements AdapterView.OnItemClickListener, DlgFrLeoSaltColorPicker.OnLeoSaltColorPickerListener, AdapterView.OnItemLongClickListener  {
   ...
   ArrayList<LeoSaltItemInfo> mItemsInfo;
    ...
    private DlgFrLeoSaltPerItemColor.LeoSaltItemsColorsListener mCallBack;

    public DlgFrLeoSaltPerItemColor(){}
    ...
    public interface LeoSaltItemsColorsListener{
        void onItemsColorsSelected(String value);
    }


    private void saveCallback(DlgFrLeoSaltPerItemColor.LeoSaltItemsColorsListener callback){
        mCallBack =callback;
    }
    ...
    private void checkCallback(){
        if(mCallBack==null) {
            if (mHelperFragment.equals(Common.TAG_PREFSSCREEN_FRAGMENT)) {
                ...
                if (prefsScreen != null)
                    mCallBack = (DlgFrLeoSaltPerItemColor.LeoSaltItemsColorsListener) prefsScreen.findAndGetCallBack(mKey);
            }else mCallBack=(DlgFrLeoSaltPerItemColor.LeoSaltItemsColorsListener) getFragmentManager().findFragmentByTag(mHelperFragment);
        }
    }



    public static DlgFrLeoSaltPerItemColor newInstance(
            DlgFrLeoSaltPerItemColor.LeoSaltItemsColorsListener callback, String HelperFragment,
        ...
        DlgFrLeoSaltPerItemColor ret = new DlgFrLeoSaltPerItemColor();
    ...
    private String getResultFromItemList(){
        ...
        for(int ind=0;ind<mItemsInfo.size();ind++) {
            LeoSaltItemInfo item = (LeoSaltItemInfo) mItemsInfo.get(ind);
    ...
    public Dialog onCreateDialog(Bundle state) {
        ...
        mItemsInfo = new ArrayList<LeoSaltItemInfo>();
        ...
        builder.setNeutralButton("?", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dlg.setTitle(getActivity().getResources().getString(R.string.LeoSalts_help));
                dlg.setMessage(getActivity().getResources().getString(R.string.LeoSalts_help_items_colors));
                dlg.setButton(DialogInterface.BUTTON_POSITIVE, getActivity().getString(R.string.LeoSalts_ok), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                    }
    ...
    private void clickAction(){
        ...
        if (dlgFrLeoSaltColorPicker==null){
            ...
            dlgFrLeoSaltColorPicker= DlgFrLeoSaltColorPicker.newInstance(this, Common.TAG_DLGFRGRITEMSCOLORS, mTitle,mKey,color,Common.getColorPickerStyleIndex(Common.userColorPickerStyle)/*false*/,
                    true,true, false); //
    ...
    private void resetItemColor(){
        ...
        LeoSaltItemInfo LeoSaltItemInfo = mItemsInfo.get(mIdItemClicked);
        int def = LeoSaltItemInfo.getDefColor();
        int col = LeoSaltItemInfo.getColor();
        if(def==col) return;
        AlertDialog dlg = new AlertDialog.Builder(getActivity()).create();
        dlg.setTitle(getActivity().getResources().getString(R.string.LeoSalts_reset_values));
        dlg.setMessage(getActivity().getResources().getString(R.string.LeoSalts_reset_message));
        dlg.setButton(DialogInterface.BUTTON_POSITIVE, getActivity().getString(R.string.LeoSalts_ok), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
    ...
    public boolean onItemLongClick (AdapterView<?> parent,
        ...
        Toast.makeText(getActivity(), getActivity().getResources().getString(R.string.LeoSalts_copied_clipboard),Toast.LENGTH_LONG).show();
        mIdItemClicked=-1;
    ...
    private void initItemsList(){
        ...
        for(int i=0;i<vals_array.length;i++){
            mItemsInfo.add(new LeoSaltItemInfo(
    ...
    private class LeoSaltItemInfo {
        ...
        public  LeoSaltItemInfo(String label, String optionvalue, Drawable icon, int defcolor, int color){
            mLabel=label;
            mIcon = icon;
    ...
    private class Qadapter extends BaseAdapter {
        ...
        List<LeoSaltItemInfo> mList;

        Qadapter(List<LeoSaltItemInfo> qlist) {
            this.mList = qlist;
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(getActivity()).inflate(R.layout.dlg_LeoSaltperitemcolor_item, null);
            ...
            LeoSaltItemInfo item = (LeoSaltItemInfo) this.getItem(position);
