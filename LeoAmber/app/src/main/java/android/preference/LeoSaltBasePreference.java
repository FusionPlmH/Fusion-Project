...
public class LeoSaltBasePreference extends Preference implements
        LeoSaltPreferenceScreen.CustomDependencyListener{
    ...
    public LeoSaltBasePreference(Context context, AttributeSet attrs) {
        super(context,attrs);
        mNumClicks =0;
    }

    public LeoSaltBasePreference(Context context, AttributeSet attrs, int defStyleAttr){
    ...
    private String getSettingsStringValue(){
        ...
        switch (myPrefAttrsInfo.getMySystemPrefType()){
            case GLOBAL:
                returnvalue = LeoSaltPrefsUtils.getStringValueFromSettingsGlobal(getContext(),myPrefAttrsInfo.getMyKey(),returnvalue,false);
                break;
            case SECURE:
                returnvalue = LeoSaltPrefsUtils.getStringValueFromSettingsSecure(getContext(),myPrefAttrsInfo.getMyKey(),returnvalue,false);
                break;
            case SYSTEM:
                returnvalue = LeoSaltPrefsUtils.getStringValueFromSettingsSystem(getContext(),myPrefAttrsInfo.getMyKey(),returnvalue,false);
                break;
            default:
                break;
        }
    ...
    private int getSettingsIntValue(){
        ...
        switch (myPrefAttrsInfo.getMySystemPrefType()){
            case SYSTEM:
                returnvalue = LeoSaltPrefsUtils.getIntValueFromSettingsSystem(getContext(),myPrefAttrsInfo.getMyKey(),myPrefAttrsInfo.getMyIntDefValue(),false);
                break;
            case SECURE:
                returnvalue =LeoSaltPrefsUtils.getIntValueFromSettingsSecure(getContext(),myPrefAttrsInfo.getMyKey(),myPrefAttrsInfo.getMyIntDefValue(),false);
                break;
            case GLOBAL:
                returnvalue =LeoSaltPrefsUtils.getIntValueFromSettingsGlobal(getContext(),myPrefAttrsInfo.getMyKey(),myPrefAttrsInfo.getMyIntDefValue(),false);
                break;
            default:
                break;
        }
    ...
    public void showResetPreferenceDialog(){
        ...
        dlg.setTitle(getContext().getResources().getString(R.string.LeoSalts_reset_values));
        dlg.setMessage(getContext().getResources().getString(R.string.LeoSalts_reset_message));
        dlg.setButton(DialogInterface.BUTTON_POSITIVE, getContext().getString(R.string.LeoSalts_ok), new DialogInterface.OnClickListener() {
            @Override
    ...
    /*********** listener and connections to LeoSaltPreferenceScreen ****************/
    ...
    /****  provide pref info to LeoSaltPreferenceScreen to process reboot and kill apps options  */
