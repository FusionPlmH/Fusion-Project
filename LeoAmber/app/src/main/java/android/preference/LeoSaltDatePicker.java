...
public class LeoSaltDatePicker extends LeoSaltBasePreference{

    private String mFormattedValue="";

    public LeoSaltDatePicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttributes(context, attrs);
    }

    public LeoSaltDatePicker(Context context, AttributeSet attrs, int defStyleAttr){
    ...
    public void showDialog(){
        ...
        if(prefsScreen!=null) prefsScreen.ShowLeoSaltDatePickerDialog(getKey(), getPersistedString(""));
    }
