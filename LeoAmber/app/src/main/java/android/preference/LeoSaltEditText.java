...
import org.leo.tweaks.salt.prefs.DlgFrEditText;
import org.leo.tweaks.salt.utils.Common;


public class LeoSaltEditText extends  LeoSaltBasePreference implements DlgFrEditText.OnLeoSaltEditTextListener{

    public LeoSaltEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttributes(context, attrs);
    }

    public LeoSaltEditText(Context context, AttributeSet attrs, int defStyleAttr){
