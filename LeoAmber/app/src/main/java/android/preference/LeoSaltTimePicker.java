...
public class LeoSaltTimePicker extends LeoSaltBasePreference {

    public LeoSaltTimePicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttributes(context, attrs);
    }

    public LeoSaltTimePicker(Context context, AttributeSet attrs, int defStyleAttr){
    ...
    public void showDialog(){
        ...
        if(prefsScreen!=null) prefsScreen.showLeoSaltTimePickerDialog(getKey(), mIntValue);
    }
