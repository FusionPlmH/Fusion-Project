...
public class LeoSaltSeekBar extends LeoSaltBasePreference implements OnSeekBarChangeListener{
    ...
    public LeoSaltSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttributes(context, attrs);
    }


    public LeoSaltSeekBar(Context context, AttributeSet attrs, int defStyleAttr){
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        setLayoutResource(R.layout.pref_LeoSaltseekbar);
        setWidgetLayoutResource(R.layout.pref_LeoSaltseekbar_widget);
        ...
        mMin = ta.getInt(R.styleable.LeoSaltPreferences_minValue,0);
        mMax = ta.getInt(R.styleable.LeoSaltPreferences_maxValue,3);
        mUnits = ta.getString(R.styleable.LeoSaltPreferences_units);
        mPopup=ta.getBoolean(R.styleable.LeoSaltPreferences_showPopup,true);
        mInterval=ta.getInt(R.styleable.LeoSaltPreferences_interval,1);

        if(ta.hasValue(R.styleable.LeoSaltPreferences_seekbarColor))
            mSeekbarColor = ta.getInt(R.styleable.LeoSaltPreferences_seekbarColor, 0);
