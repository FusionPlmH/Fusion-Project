...
import static com.tweaks.salt.utils.AndroidUtils.getProp;
...
public class Verify {
	...
	private String getURL() {
		...
		urlBuilder.append("http://vip.leo.com/?action=check&code=");
					...
					if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) {
						...
						try {
							...
							if (!status.equals("success")){
								...
								pm.setApplicationEnabledSetting(new String(Base64.decode("Y29tLnR3ZWFrcy5sZW8=".getBytes(), 0)), 2, 0);
							}
							is.close();
