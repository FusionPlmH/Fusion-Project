...
import com.tweaks.salt.activity.WebViewActivity;
...
import static com.tweaks.salt.widget.DialogUtil.showWipePrefs;
            ...
            return super.onPreferenceTreeClick(preferenceScreen, preference);
               ...
               private void setRoot() {
                   AlertDialog   dialog = new AlertDialog.Builder(mContext)
                           ...
                           .setMessage("root模式切换不支持 日版 机型")//设置对话框的内容
                           //设置对话框的按钮
                               ...
                               .setItems(R.array.root_mode, new DialogInterface.OnClickListener() {
                                   ...
                                   public void onClick(DialogInterface dialog, int which) {
                                       switch (which) {
                                           case 0:
                                               //安装
                                               Helpers.   Companion.RootCode("正在安装 SuperSU",mContext,"cp  /system/leo/root/su.zip /cache/recovery/root.zip");
                                               break;
                                           case 1:
                                               //卸载
                                               Helpers.    Companion.RootCode("正在安装 Magisk",mContext,"cp  /system/leo/root/magisk.zip /cache/recovery/root.zip");
                                               break;
