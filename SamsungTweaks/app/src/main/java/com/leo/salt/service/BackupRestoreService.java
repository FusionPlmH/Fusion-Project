...
public class BackupRestoreService extends IntentService {
    ...
    private class LocalReceiver extends BroadcastReceiver {
        static final String BACKUP_COMPLETE_ACTION = "com.fusionleo.salt.action.BACKUP_COMPLETE";
        static final String RESTORE_COMPLETE_ACTION = "com.fusionleo.salt.action.RESTORE_COMPLETE";
