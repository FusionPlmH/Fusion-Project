...
import static com.fusionleo.salt.utils.Constants.WALLPAPER_KEY;
...
public class StatusBarWallpaperPicker extends WallpaperPicker {
    ...
    //String StringKey = ("/data/data/com.fusionleo.salt/wallpaper/leo_statusbar_bg_wallpaper_" + System.currentTimeMillis() + ".jpg");
