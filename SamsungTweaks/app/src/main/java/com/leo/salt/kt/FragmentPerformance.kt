...
import com.fusionleo.salt.utils.Constants.GLOBAL_SPF
...
class FragmentPerformance : Fragment() {
    ...
    private fun setModeState() {
        ...
        when (cfg) {
            modeList.BALANCE -> btn_defaultmode.text = getString(R.string.equilibrium)+" √"
            modeList.PERFORMANCE -> btn_gamemode.text = getString(R.string.performance)+" √"
            modeList.POWERSAVE -> btn_powersave!!.text = getString(R.string.power_saving)+" √"
            modeList.FAST -> btn_fastmode!!.text = getString(R.string.quickness)+" √"
        }
    }
