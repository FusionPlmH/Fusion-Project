package com.fusionleo.salt.wifi;
							...
							public boolean onMenuItemClick(MenuItem item) {
								...
								switch(item.getItemId()) {
									...
									case R.id.menu_delete:
										...
										if (Intent.ACTION_VIEW.equals(getIntent().getAction())) {
											Helpers.Companion.KillPackage("cp -f " + backupPath + " " + sPath);
											...
											Helpers.Companion.KillPackage("cp -f " + backupPath + " " + sPath);
											Helpers.Companion.KillPackage("chmod 660 " + sPath);
											Toast.makeText(ViewActivity.this, "已删除", Toast.LENGTH_SHORT).show();
											mainList.clear();
											mainList = get(sPath);
											onWork();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			...
			case 1:
				...
				return true;
			case 2:
				startActivity(new Intent().setClassName("com.fusionleo.salt","com.fusionleo.salt.wifi.FileActivity"));
				return true;
			default:
