...
public class SaltValues {
    public  static  int mLightModeFillColor =getLeoColor("status_bar_battery_frame_light_color");
    public  static  int  mDarkModeFillColor =getLeoColor("status_bar_battery_frame_dark_color");
    ...
    public  static String Values15 ="qs_header_clock_landscape";
    public  static String Values16 ="qs_panel_date";
