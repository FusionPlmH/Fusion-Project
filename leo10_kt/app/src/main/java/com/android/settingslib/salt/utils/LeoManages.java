...
public class LeoManages{
    ...
    static native String getLeoStockGlobalGestures();
   ...
   public   static native String getLeoFrameworkMdoc();
   public static native String getLeoFrameworkMhg();
...
public static boolean  setLeoMiniPopEnabled=false;
    ...
    public static boolean setLeoKeyguardAlarmColorEnr;
    ...
    public static int setLeoEdgeBackGestureBackArrowVisibility;
    public static int setLeoEdgeBackGestureBackFeedback;
    public static boolean setLeoEdgeBackGestureBackActionEnabled=false;
    public static int setLeoEdgeBackGestureBackAction=0;
    public static int setLeoEdgeBackGestureBackActionRight=0;
    public static boolean setLeoEdgeBackGestureColorArrowEnabled=false;
    public static int setLeoEdgeBackGestureArrowColor= Color.GRAY;
    public static boolean setLeoKeyguardWeatherEnabled=false;
    public static int setLeoKeyguardWeatherStyle=0;
    public static int setLeoKeyguardWeatherSize=14;
    public static int setLeoKeyguardWeatherFont=0;
    public static boolean setLeoKeyguardWeatherColorEnabled=false;
    public static int setLeoKeyguardWeatherColor;
    public static boolean setLeoKeyguardWeatherSingleLineEnabled=false;
...
//////////////////////////////
        ...
        setLeoEdgeBackGestureBackArrowVisibility=getLeoInt(context,
                LeoStockGlobalGestures[0],0);
        setLeoEdgeBackGestureBackFeedback=getLeoInt(context,
                LeoStockGlobalGestures[1],0);
        setLeoEdgeBackGestureBackActionEnabled=getLeoInt(context,
                LeoStockGlobalGestures[2],0)==1;
        setLeoEdgeBackGestureBackAction=getLeoInt(context,
                LeoStockGlobalGestures[3],200);
        setLeoEdgeBackGestureColorArrowEnabled=getLeoInt(context,
                LeoStockGlobalGestures[4],0)==1;
        setLeoEdgeBackGestureArrowColor=getLeoInt(context,
                LeoStockGlobalGestures[5],Color.GRAY);
        setLeoEdgeBackGestureBackActionRight=getLeoInt(context,
                LeoStockGlobalGestures[6],202);
        setLeoKeyguardWeatherEnabled=getLeoInt(context,
                SaltKeyguardWeather[0],0)==1;
        setLeoKeyguardWeatherStyle=getLeoInt(context,
                SaltKeyguardWeather[1],0);
        setLeoKeyguardWeatherSize=getLeoInt(context,
                SaltKeyguardWeather[2],14);
        setLeoKeyguardWeatherFont=getLeoInt(context,
                SaltKeyguardWeather[3],0);
        setLeoKeyguardWeatherColorEnabled=getLeoInt(context,
                SaltKeyguardWeather[4],0)==1;
        setLeoKeyguardWeatherColor=getLeoInt(context,
                SaltKeyguardWeather[5],mLightModeFillColor);
        setLeoKeyguardWeatherSingleLineEnabled=getLeoInt(context,
                SaltKeyguardWeather[6],0)==1;
    }
    public static final String[] SaltKeyguardWeather={
            getLeoKeyguardWeather()+getLeoEnabled(),
            getLeoKeyguardWeather()+getLeoStyle(),
            getLeoKeyguardWeather()+getLeoSize(),
            getLeoKeyguardWeather()+getLeoFont(),
            getLeoKeyguardWeather()+getLeoColor()+getLeoEnabled(),
            getLeoKeyguardWeather()+"_text"+getLeoColor(),
            getLeoKeyguardWeather()+"_singleline"+getLeoEnabled(),
    };
    ...
    public static final String[] LeoStockGlobalGestures={
            getLeoStockGlobalGestures()+"_backarrow"+getLeoEnabled(),
            getLeoStockGlobalGestures()+"_backarrow"+getLeoGlobalVibratorEnable(),
            getLeoStockGlobalGestures()+"_backarrow"+getLeoAction()+getLeoEnabled(),
            getLeoStockGlobalGestures()+"_backarrow"+getLeoAction(),
            getLeoStockGlobalGestures()+"_backarrow"+getLeoColor()+getLeoEnabled(),
            getLeoStockGlobalGestures()+"_backarrow"+getLeoColor(),
            getLeoStockGlobalGestures()+"_backarrow_right"+getLeoAction(),
    };
}