...
public class NavigationBarView extends FrameLayout {
    ...
    protected final EdgeBackGestureHandler mEdgeBackGestureHandler;
    ...
    public void updateSaltBackArrowForGesture() {
        mEdgeBackGestureHandler.setSaltForBackArrowGesture();
    }
