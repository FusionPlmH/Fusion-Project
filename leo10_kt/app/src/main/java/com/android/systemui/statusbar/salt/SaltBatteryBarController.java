...
import static com.android.settingslib.salt.SaltConfigFrame.Prefs.getLastBatteryLevel;
import static com.android.settingslib.salt.SaltConfigFrame.Prefs.setLastBatteryLevel;
...
import static com.android.settingslib.salt.utils.LeoManages.setLeoStatusBarBatteryBarLocation;
import static com.android.settingslib.salt.utils.LeoManages.setLeoStatusBarBatteryBarStyle;
import static com.android.settingslib.salt.utils.LeoManages.setLeoStatusBarBatteryBarThickness;
import static com.android.systemui.statusbar.phone.StatusBar.SALT_UPDATE_BATTERY_SETTINGS;


public class SaltBatteryBarController extends LinearLayout {
    ...
    public SaltBatteryBarController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext=context;
        if (attrs != null) {
    ...
    protected void onAttachedToWindow() {
        ...
        if (!isAttached) {
            ...
            filter.addAction(rt100foleo(SALT_UPDATE_BATTERY_SETTINGS));
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            }else if (action.equals(rt100foleo(SALT_UPDATE_BATTERY_SETTINGS))) {//SALT_UPDATE_BATTERY_SETTINGS
    ...
    public void addBars() {
        ...
        if (mStyle == STYLE_REGULAR) {
            addView(new  SaltBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical),
                    new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
                            LayoutParams.MATCH_PARENT, 1));
        } else if (mStyle == STYLE_SYMMETRIC) {
           SaltBatteryBar bar1 = new  SaltBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical);
            SaltBatteryBar bar2 = new  SaltBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical);
            ...
            SaltBatteryBar bar = new  SaltBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical);
            bar.setRotation(180);
