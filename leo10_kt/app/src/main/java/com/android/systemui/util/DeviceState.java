...
public final class DeviceState {
    ...
    public static int getActiveSimCount(Context context) {
        ...
        int i2 = 0;
        while (i2 < sPhoneCount) {
            str = getMSimSystemProperty("gsm.sim.state", i2, "NOT_READY");
            if (("READY".equals(str) || "LOADED".equals(str)) && getSimSettingState(context, i2) != 0) {
                i++;
            }
            i2++;
        }
    ...
    private static final int sPhoneCount = 0;
