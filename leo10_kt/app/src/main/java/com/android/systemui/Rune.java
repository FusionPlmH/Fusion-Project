...
public class Rune {
    public static  boolean STATBAR_SUPPORT_NOTIFICATION_PANEL_PLMN_ZVV = false;
    ...
    public static  boolean NAVBAR_ENABLED =true;
    ...
    public static  boolean NAVBAR_SUPPORT_GESTURE=true;
    public static  boolean NAVBAR_SUPPORT_REMOTEVIEW=true;
