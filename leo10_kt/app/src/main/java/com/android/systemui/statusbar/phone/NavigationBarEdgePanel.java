...
import static com.android.settingslib.salt.utils.LeoManages.setLeoEdgeBackGestureArrowColor;
import static com.android.settingslib.salt.utils.LeoManages.setLeoEdgeBackGestureBackArrowVisibility;
import static com.android.settingslib.salt.utils.LeoManages.setLeoEdgeBackGestureBackFeedback;
import static com.android.settingslib.salt.utils.LeoManages.setLeoEdgeBackGestureColorArrowEnabled;
...
public class NavigationBarEdgePanel extends View {
  ...
  //  private final VibratorHelper mVibratorHelper;
    ...
    private int mSaltCustomArrowColor;
    private boolean mSaltCustomColorArrow;
    /**
    ...
    public int mSaltBackArrowVisibility;
    public int mSaltBackFeedback;
    /**
    ...
    private void updateIsDark(boolean animate) {
        ...
        int saly;
        boolean of=setLeoEdgeBackGestureColorArrowEnabled;
        if(of){
            saly =setLeoEdgeBackGestureArrowColor;
        } else {
            saly=mIsDark ? this.mArrowColorDark : this.mArrowColorLight;
        }
        mArrowColor=saly;
    ...
    public void setSaltBackArrowSatyle() {
        LeoSysUiManages(mContext);
        loadColors(mContext);
        mSaltBackArrowVisibility = setLeoEdgeBackGestureBackArrowVisibility;
        mSaltBackFeedback =setLeoEdgeBackGestureBackFeedback;
    }
