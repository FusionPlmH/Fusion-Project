...
class SystemGesturesPointerEventListener implements PointerEventListener {
    ...
    public void setSaltTopGestureSlide(MotionEvent event) {
        Context context = this.mContext;
        LeoSetting(context);
        if(setLeoGlobalEnableFingerGestures){
            if (event.getPointerCount() ==getSaltGesturesFingersCount(context) ) {
    ...
    public void setSaltLeftGestureSlide(MotionEvent event) {
        Context context = this.mContext;
        LeoSetting(context);
        if(setLeoGlobalEnableFingerGestures){
            if (event.getPointerCount() ==getSaltGesturesFingersCount(context) ) {
    ...
    public void setSaltRightGestureSlide(MotionEvent event) {
        Context context = this.mContext;
        LeoSetting(context);
        if(setLeoGlobalEnableFingerGestures){
            if (event.getPointerCount() ==getSaltGesturesFingersCount(context) ) {
    ...
    public void setSaltBottomGestureSlide(MotionEvent event) {
        Context context = this.mContext;
        LeoSetting(context);
        if(setLeoGlobalEnableFingerGestures){
            if (event.getPointerCount() ==getSaltGesturesFingersCount(context) ) {
    ...
    public int getSaltGesturesFingersCount(Context context) {
        LeoSetting(context);
