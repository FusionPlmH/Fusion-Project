...
public class SaltPhoneSetting{
    public static  String Config ="salt-server";
    static {
    ...
    static native String getLeoGlobalBixbyLongPressAction();
    static native String getLeoGlobalBixbyClickAction();
     static native String getLeoGlobalBixbyEnableAction();
   static native String getLeoGlobalVibratorEnable();
    static native String getLeoGlobalVibratorLevel();

    static native String getLeoGlobalPowerDoubleAction();
     static native String getLeoGlobalPowerLongPressAction();

     static native String getLeoGlobalPowerEnableAction();

    static native String getLeoGlobalFingerprintUPAction();
  static native String getLeoGlobalFingerprintDownAction();

   static native String getLeoGlobalHwKeysEnableAction();
   static native String getLeoGlobalLongPressOnRecentAction();
   static native String getLeoGlobalLongPressOnHomeAction();
    static native String getLeoGlobalLongPressOnBackAction();
  public   static  String mLeoGlobalService=getLeoService();
    ...
    public static  int setGlobalToastWarn;

    public static void LeoSetting(Context context){
        setGlobalToastWarn=getLeoInt(context,"leo_phone_action_toast",0);
