...
import static com.android.server.utils.salt.SaltPhoneSetting.ConfigManager;
import static com.android.server.utils.salt.SaltPhoneSetting.getLeoService;
...
public class SaltServerFrame {
    ...
    public static  String LEOFRAMEWORK= ConfigManager;
