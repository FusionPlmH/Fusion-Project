...
class PolicyControl {
    ...
    static int getSystemUiVisibility(WindowManagerPolicy.WindowState win, LayoutParams attrs) {
        attrs = attrs != null ? attrs : win.getAttrs();
        int vis = win != null ? win.getSystemUiVisibility()
                : (attrs.systemUiVisibility );
    ...
    static int getWindowFlags(WindowManagerPolicy.WindowState win, LayoutParams attrs) {
        attrs = attrs != null ? attrs : win.getAttrs();
    ...
    static int adjustClearableFlags(WindowManagerPolicy.WindowState win, int clearableFlags) {
  ...
  public static boolean reloadFromSetting2(Context context) {
