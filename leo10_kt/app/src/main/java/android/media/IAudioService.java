...
public interface IAudioService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAudioService {
        ...
        static final int TRANSACTION_addPackage = 100;
        ...
        static final int TRANSACTION_dismissVolumePanel = 120;
        ...
        static final int TRANSACTION_getAppDevice = 88;
        static final int TRANSACTION_getAppVolume = 90;
        static final int TRANSACTION_getAudioServiceConfig = 85;
        static final int TRANSACTION_getCurrentAudioFocus = 42;
        static final int TRANSACTION_getCurrentAudioFocusPackageName = 121;
        static final int TRANSACTION_getFineVolume = 96;
        static final int TRANSACTION_getFocusRampTimeMs = 76;
        static final int TRANSACTION_getLastAudibleStreamVolume = 15;
        static final int TRANSACTION_getMediaVolumeSteps = 115;
        static final int TRANSACTION_getMode = 26;
        static final int TRANSACTION_getMuteInterval = 110;
        static final int TRANSACTION_getPinAppInfo = 97;
        static final int TRANSACTION_getPinDevice = 98;
        static final int TRANSACTION_getPrevRingerMode = 112;
        static final int TRANSACTION_getRadioOutputPath = 117;
        static final int TRANSACTION_getRemainingMuteIntervalMs = 111;
        ...
        static final int TRANSACTION_getSelectedAppList = 99;
        ...
        static final int TRANSACTION_isFMPlayerActive = 118;
        static final int TRANSACTION_isForceSpeakerOn = 107;
        static final int TRANSACTION_isHdmiSystemAudioSupported = 62;
        static final int TRANSACTION_isInAllowedList = 103;
        static final int TRANSACTION_isMasterMute = 10;
        static final int TRANSACTION_isMultiSoundOn = 92;
        static final int TRANSACTION_isSafeMediaVolumeStateActive = 105;
        ...
        static final int TRANSACTION_removePackageForName = 101;
        static final int TRANSACTION_requestAudioFocus = 39;
        static final int TRANSACTION_secGetActiveStreamType = 119;
        static final int TRANSACTION_setAppDevice = 87;
        static final int TRANSACTION_setAppVolume = 89;
        static final int TRANSACTION_setAudioServiceConfig = 84;
        ...
        static final int TRANSACTION_setDeviceToForceByUser = 108;
        static final int TRANSACTION_setFineVolume = 94;
        ...
        static final int TRANSACTION_setForceSpeakerOn = 106;
        ...
        static final int TRANSACTION_setMediaVolumeSteps = 114;
        static final int TRANSACTION_setMicrophoneMute = 16;
        static final int TRANSACTION_setMode = 25;
        static final int TRANSACTION_setMultiSoundOn = 91;
        static final int TRANSACTION_setMuteInterval = 109;
        static final int TRANSACTION_setRadioOutputPath = 116;
        ...
        static final int TRANSACTION_setSoundSettingEventBroadcastIntent = 113;
        static final int TRANSACTION_setSpeakerphoneOn = 33;
        static final int TRANSACTION_setStreamVolume = 7;
        static final int TRANSACTION_setStreamVolumeForDevice = 93;
        ...
        private static class Proxy implements IAudioService {
            ...
            public String getCurrentAudioFocusPackageName() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getCurrentAudioFocusPackageName, _data, _reply, 0);
            ...
            public int trackPlayer(PlayerIdCard playerIdCard) throws RemoteException {
                return 0;
            }
            ...
            public void setAppDevice(int uid, int device) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setMultiSoundOn(boolean on) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setStreamVolumeForDevice(int streamType, int index, int flags, String callingPackage, int device) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void makeBTVolumeSame(String lastAddr, String toBeChangedAddr) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(lastAddr);
                    _data.writeString(toBeChangedAddr);
            ...
            public int setDeviceToForceByUser(int device, String address) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(device);
                    _data.writeString(address);
                    this.mRemote.transact(Stub.TRANSACTION_setDeviceToForceByUser, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public void setMuteInterval(int interval, String caller) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(caller);
                    this.mRemote.transact(Stub.TRANSACTION_setMuteInterval, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getMuteInterval() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getMuteInterval, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int getRemainingMuteIntervalMs() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getRemainingMuteIntervalMs, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public void setSoundSettingEventBroadcastIntent(int type, PendingIntent broadcastIntent) throws RemoteException {
                ...
                try {
                    ...
                    if (broadcastIntent != null) {
                        _data.writeInt(1);
                        broadcastIntent.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_setSoundSettingEventBroadcastIntent, _data, null, 1);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public boolean setMediaVolumeSteps(int[] volumeSteps) throws RemoteException {
                ...
                try {
                    ...
                    boolean z = false;
                    this.mRemote.transact(Stub.TRANSACTION_setMediaVolumeSteps, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        z = true;
                    }
            ...
            public int[] getMediaVolumeSteps() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getMediaVolumeSteps, _data, _reply, 0);
                    _reply.readException();
            ...
            public void setRadioOutputPath(int path) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(path);
                    this.mRemote.transact(Stub.TRANSACTION_setRadioOutputPath, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getRadioOutputPath() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getRadioOutputPath, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public boolean isFMPlayerActive() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean z = false;
                    this.mRemote.transact(Stub.TRANSACTION_isFMPlayerActive, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        z = true;
                    }
            ...
            public int secGetActiveStreamType(int suggestedStreamType) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(suggestedStreamType);
                    this.mRemote.transact(Stub.TRANSACTION_secGetActiveStreamType, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public void dismissVolumePanel() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_dismissVolumePanel, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean isUsingAudio(int uid) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(uid);
                    boolean z = false;
                    this.mRemote.transact(Stub.TRANSACTION_isUsingAudio, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        z = true;
                    }
