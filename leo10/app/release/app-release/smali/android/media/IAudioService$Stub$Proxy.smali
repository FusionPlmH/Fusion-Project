...
.method public abandonAudioFocus(Landroid/media/IAudioFocusDispatcher;Ljava/lang/String;Landroid/media/AudioAttributes;Ljava/lang/String;)I
    ...
    invoke-virtual {p3, v0, p1}, Landroid/media/AudioAttributes;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object p2, p0, Landroid/media/IAudioService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public addMixForPolicy(Landroid/media/audiopolicy/AudioPolicyConfig;Landroid/media/audiopolicy/IAudioPolicyCallback;)I
    ...
    iget-object p1, p0, Landroid/media/IAudioService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getFocusRampTimeMs(ILandroid/media/AudioAttributes;)I
    ...
    invoke-virtual {p2, v0, p1}, Landroid/media/AudioAttributes;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public registerAudioPolicy(Landroid/media/audiopolicy/AudioPolicyConfig;Landroid/media/audiopolicy/IAudioPolicyCallback;ZZZ)Ljava/lang/String;
    ...
    :try_start_0
    const-string p5, "android.media.IAudioService"

    invoke-virtual {p3, p5}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p3, p5}, Landroid/media/audiopolicy/AudioPolicyConfig;->writeToParcel(Landroid/os/Parcel;I)V

    goto :goto_0

    :cond_0
    invoke-virtual {p3, p5}, Landroid/os/Parcel;->writeInt(I)V
    ...
    invoke-virtual {p4}, Landroid/os/Parcel;->readString()Ljava/lang/String;
...
.method public setBluetoothA2dpDeviceConnectionStateSuppressNoisyIntent(Landroid/bluetooth/BluetoothDevice;IIZI)I
    ...
    invoke-virtual {p1, p4, v1}, Landroid/bluetooth/BluetoothDevice;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-interface {p1, p2, p4, v0, v1}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
...
.method public setMasterMute(ZILjava/lang/String;I)V
    ...
    invoke-interface {p2, p3, p1, v0, p4}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
...
.method public setMicrophoneMute(ZLjava/lang/String;I)V
    ...
    invoke-interface {p2, p3, p1, v0, v1}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
...
.method public trackPlayer(Landroid/media/PlayerIdCard;)I
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
