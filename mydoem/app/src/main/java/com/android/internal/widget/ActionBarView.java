...
public class ActionBarView extends AbsActionBarView implements DecorToolbar {
    ...
    public void setLeoAppTitleBackground(Context ctx) {


            if(Settings.System.getInt(ctx.getContentResolver(), "leo_tweaks_activity_bg_enable", 0)==1){
                ColorDrawable backgroundcolor = new ColorDrawable(Color.TRANSPARENT);
               setBackground(backgroundcolor);
        }
    }
    public void   setAppsTitle(TextView titleView ,CharSequence title) {
        LeoSettings(titleView.getContext());
  ...
  Context  mContext;
    ...
    protected void onFinishInflate() {
        ...
        setLeoAppTitleBackground(getContext());
    ...
    private static class HomeView extends FrameLayout implements com.android.internal.widget.HomeView {
