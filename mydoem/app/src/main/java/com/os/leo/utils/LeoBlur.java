...
import static libcore.io.Streams.copy;

public class  LeoBlur {
    private static final String TAG = "LeoBlur";
    private static final float SCALE = 1 / 8.0F;//default scale
    private static volatile LeoBlur singleton = null;
     ...
     * @return
     */
    public static LeoBlur with(Context context){
        if (singleton == null) {
            synchronized (LeoBlur.class) {
                if (singleton == null) {
                    singleton = new LeoBlur(context);
                }
            }
        }
        return singleton;
    ...
    private LeoBlur(Context context){
     ...
     * @return
     */
    public LeoBlur policy(BlurPolicy policy){
        this.mPolicy = policy;
        return this;
    }
     ...
     * @return
     */
    public LeoBlur bitmap(Bitmap bitmap){
        this.mBitmap = bitmap;
        return this;
    }
     ...
     * @return
     */
    public LeoBlur scale(int scale){
     ...
     * @return
     */
    public LeoBlur radius(int radius){
        this.mRadius = radius;
        return this;
    }
