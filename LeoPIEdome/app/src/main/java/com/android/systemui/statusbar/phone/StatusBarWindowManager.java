...
import static com.android.fusionleo.statusbar.LeoStatusbarSettings.setNotificationPanelBlurEnabled;
import static com.android.fusionleo.statusbar.LeoStatusbarSettings.setNotificationPanelBlurLevel;
...
public class StatusBarWindowManager {
   ...
   // private final IActivityManager mActivityManager;
    ...
    private void LeoNotificationPanelBlur() {
        LeoStatusSettings(mContext);
        if (setNotificationPanelBlurEnabled) {
            float f = ((float) setNotificationPanelBlurLevel) / 100.0f;
