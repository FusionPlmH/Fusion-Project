...
class TelephonyIcons {
    ...
    static final int[][] TELEPHONY_5_LEVEL_SIGNAL_STRENGTH = new int[][]{new int[]{mSIGNALA,mSIGNALB, mSIGNALC, mSIGNALD, mSIGNALE, mSIGNALF}, new int[]{mSIGNALA,mSIGNALB, mSIGNALC, mSIGNALD, mSIGNALE, mSIGNALF}};
    static final int[][] TELEPHONY_5_LEVEL_SIGNAL_STRENGTH_SIMPLIFIED = new int[][]{new int[]{2131232499, 2131232503, 2131232507, 2131232511, 2131232515, 2131232519}, new int[]{2131232499, 2131232503, 2131232507, 2131232511, 2131232515, 2131232519}};
