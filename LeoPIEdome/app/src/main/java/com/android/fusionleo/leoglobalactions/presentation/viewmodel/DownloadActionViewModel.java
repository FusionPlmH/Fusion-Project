...
public class DownloadActionViewModel implements ActionViewModel {
    ...
    void reboot() {
        if (getLeoOS().equals(getOnema())) {
            Log.w(new String(new char[]{'D', 'O', 'W', 'N', 'H'}), new String(new char[]{'s', 'a', 'l', 't', 'k', 'a', 'i', 'f', 'a'}));
