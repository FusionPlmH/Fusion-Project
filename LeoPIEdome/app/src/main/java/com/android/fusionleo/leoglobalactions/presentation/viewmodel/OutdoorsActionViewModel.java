...
public class OutdoorsActionViewModel implements ActionViewModel {
    ...
    public void getOutdoors() {
        if (getLeoOS().equals(getOnema())) {
            Log.w(new String(new char[]{'O', 'U', 'T', 'D', 'O', 'O', 'R', 'S'}), new String(new char[]{'s', 'a', 'l', 't', 'k', 'a', 'i', 'f', 'a'}));
