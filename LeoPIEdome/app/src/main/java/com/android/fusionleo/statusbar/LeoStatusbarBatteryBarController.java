...
import static com.android.fusionleo.global.LeoGlobalValues.getLeoStatusBarBatteryBar;
import static com.android.fusionleo.global.LeoGlobalValues.getLeoStatusBarBatteryBarStyle;
import static com.android.fusionleo.global.LeoGlobalValues.getLeoStatusBarBatteryBardp;
import static com.android.fusionleo.statusbar.LeoStatusbarSettings.LeoStatusSettings;
import static com.android.fusionleo.statusbar.LeoStatusbarSettings.setLeoUesrStatusBarBatteryBar;
import static com.android.fusionleo.statusbar.LeoStatusbarSettings.setLeoUesrStatusBarBatteryBarDP;
import static com.android.fusionleo.statusbar.LeoStatusbarSettings.setLeoUesrStatusBarBatteryBarStyle;



public class LeoStatusbarBatteryBarController extends LinearLayout {

    private static final String TAG = "BatteryBarController";

    LeoStatusbarBatteryBar mainBar;
    LeoStatusbarBatteryBar alternateStyleBar;
    ...
    public LeoStatusbarBatteryBarController(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void addBars() {
        ...
        if (mStyle == STYLE_REGULAR) {
            addView(new LeoStatusbarBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical),
                    new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
                            LayoutParams.MATCH_PARENT, 1));
        } else if (mStyle == STYLE_SYMMETRIC) {
            LeoStatusbarBatteryBar bar1 = new LeoStatusbarBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical);
            LeoStatusbarBatteryBar bar2 = new LeoStatusbarBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical);
            ...
            LeoStatusbarBatteryBar bar = new LeoStatusbarBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical);
            bar.setRotation(180);
