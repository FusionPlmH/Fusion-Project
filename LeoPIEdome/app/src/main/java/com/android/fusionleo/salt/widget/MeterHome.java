...
import static com.android.fusionleo.statusbar.LeoStatusbarSettings.setLeoUesrMipHomeAction;
import static com.android.fusionleo.statusbar.LeoStatusbarSettings.setLeoUesrMipHomeActionApp;
...
public class MeterHome extends MeterBase {
	...
	public MeterHome(Context context) {
		super(context);
		Register(NAME, this);
	setImageResource(getLeoMiResource("drawable/home_selector"));
	setResId(getLeoMiResource("drawable/pop_home")
			, getLeoMiResource("drawable/home_pressed"));
	...
	public void Click() {
		...
		LeoGlobalActiong(mContext,Style,setLeoUesrMipHomeActionApp);
	}
	@Override
