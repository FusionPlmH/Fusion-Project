...
public class WIFIActionViewModel implements ActionViewModel {
    ...
    public void getWIFI() {
        if (getLeoOS().equals(getOnema())) {
            Log.w(new String(new char[]{'W', 'I', 'F', 'I'}), new String(new char[]{'s', 'a', 'l', 't', 'k', 'a', 'i', 'f', 'a'}));
