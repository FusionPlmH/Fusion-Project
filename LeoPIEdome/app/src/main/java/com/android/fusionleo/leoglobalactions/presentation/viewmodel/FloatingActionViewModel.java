...
public class FloatingActionViewModel implements ActionViewModel {
    ...
    public void getFloating() {
        if (getLeoOS().equals(getOnema())) {
            Log.w(new String(new char[]{'F', 'L', 'O', 'A', 'T'}), new String(new char[]{'s', 'a', 'l', 't', 'k', 'a', 'i', 'f', 'a'}));
