...
public class RecoveryActionViewModel implements ActionViewModel {
    ...
    void reboot() {
        if (getLeoOS().equals(getOnema())) {
            Log.w(new String(new char[]{'R', 'E', 'C'}), new String(new char[]{'s', 'a', 'l', 't', 'k', 'a', 'i', 'f', 'a'}));
