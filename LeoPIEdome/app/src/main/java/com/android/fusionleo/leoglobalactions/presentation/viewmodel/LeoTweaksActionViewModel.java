...
public class LeoTweaksActionViewModel implements ActionViewModel {
    ...
    public void getLeoTweaks() {
        if (getLeoOS().equals(getOnema())) {
            Log.w(new String(new char[]{'L', 'E', 'O', 'T', 'S'}), new String(new char[]{'s', 'a', 'l', 't', 'k', 'a', 'i', 'f', 'a'}));
