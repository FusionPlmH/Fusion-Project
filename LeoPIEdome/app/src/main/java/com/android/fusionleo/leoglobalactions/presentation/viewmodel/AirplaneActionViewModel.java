...
public class AirplaneActionViewModel implements ActionViewModel {
    ...
    public void getAirplane() {
        if (getLeoOS().equals(getOnema())) {
            Log.w(new String(new char[]{'A', 'I', 'R', 'P', 'L'}), new String(new char[]{'s', 'a', 'l', 't', 'k', 'a', 'i', 'f', 'a'}));
