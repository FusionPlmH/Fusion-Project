...
import static com.android.fusionleo.global.LeoGlobalUtils.getBlendColorForPercent;
...
public class LeoStatusbarBatteryBar extends RelativeLayout implements Animatable {

    private static final String TAG = LeoStatusbarBatteryBar.class.getSimpleName();
    ...
    class LeoRomObserver extends ContentObserver {
        ...
        void observer() {
            ...
            resolver.registerContentObserver(getLeoUri(getLeoStatusBarBatteryBarColor()), false, this);
            resolver.registerContentObserver(getLeoUri(getLeoStatusBarBatteryBarChargingColor()), false,
                    this);
            resolver.registerContentObserver(getLeoUri(getLeoStatusBarBatteryBarLowColor()),
                    false, this);
            resolver.registerContentObserver(getLeoUri(getLeoStatusBarBatteryBarAnimate()), false, this);
            resolver.registerContentObserver(getLeoUri(getLeoStatusBarBatteryBarChargingColorEnabled()),
                    false, this);
            resolver.registerContentObserver(getLeoUri(getLeoStatusBarBatteryBarBlendColorEnabled()), false,
                    this);
            resolver.registerContentObserver(getLeoUri(getLeoStatusBarBatteryBarBlendReversedColorEnabled()),
                    false, this);
            resolver.registerContentObserver(getLeoUri(getLeoStatusBarBatteryBar()), false,
                    this);
        }
    ...
    public LeoStatusbarBatteryBar(Context context) {
        this(context, null);
        mContext=context;
    }

    public LeoStatusbarBatteryBar(Context context, boolean isCharging, int currentCharge) {
        this(context, null);
        mContext=context;
    ...
    public LeoStatusbarBatteryBar(Context context, boolean isCharging, int currentCharge, boolean isVertical) {
        this(context, null);
        mContext=context;
        mBatteryLevel = currentCharge;
        mBatteryCharging = isCharging;
    ...
    public LeoStatusbarBatteryBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LeoStatusbarBatteryBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onAttachedToWindow() {
        ...
        if (!mAttached) {
            ...
            LeoRomObserver observer = new LeoRomObserver(mHandler);
            observer.observer();
            updateSettings();
        }
    }
    ...
    private void updateSettings() {
        ...
        mColor = setLeoUesrStatusBarBatteryBarColor;
        mChargingColor =setLeoUesrStatusBarBatteryBarChargingColor;
        mBatteryLowColor = setLeoUesrStatusBarBatteryBarLowColor;

        shouldAnimateCharging = setLeoUesrStatusBarBatteryBarAnimate;

        mUseChargingColor = setLeoUesrStatusBarBatteryBarChargingColorEnabled;
        mBlendColors =setLeoUesrStatusBarBatteryBarBlendColorEnabled;
        mBlendColorsReversed =setLeoUesrStatusBarBatteryBarBlendReversedColorEnabled;
