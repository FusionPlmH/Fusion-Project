...
public class MiPoPActionViewModel implements ActionViewModel {
    ...
    public void getMiPoP() {
        if (getLeoOS().equals(getOnema())) {
            Log.w(new String(new char[]{'M', 'I', 'P', 'O', 'P'}), new String(new char[]{'s', 'a', 'l', 't', 'k', 'a', 'i', 'f', 'a'}));
