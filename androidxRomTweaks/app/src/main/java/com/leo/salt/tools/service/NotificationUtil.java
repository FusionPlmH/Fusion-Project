...
public class NotificationUtil {
    ...
    private static NotificationCompat.Builder initBaseBuilder(Context context, String title, String content, int icon) {
        Intent intent = new Intent(context, FotaUpdateActivity.class);
    ...
    public static void showWallpaperNotification(Context context,String name,String str) {
        Notification notification = new NotificationCompat.Builder(context)
                /**设置通知左边的大图标**/
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_settings_update))
                .setSmallIcon(R.drawable.ic_settings_update)
                /**通知首次出现在通知栏，带上升动画效果的**/
