...
public class LeoGlobalLunar {
    ...
    public String toLunarChineseZodiacTimeMultiSrting() {
        ...
        return cyclical()+  animalsYear() + year1 + "\n" +(leap ? run1 : "") + lunarMonthName[month - 1]+
                month1+
    ...
    public static final String[] ConstellationArray = { DATEView("constellation_Aquarius"),DATEView("constellation_Pisces"), DATEView("constellation_Aries"),
            DATEView("constellation_Taurus"), DATEView("constellation_Gemini"), DATEView("constellation_Cancer"), DATEView("constellation_Leo"),
            DATEView("constellation_Virgo"), DATEView("constellation_Libra"), DATEView("constellation_Scorpio"), DATEView("constellation_Sagittarius"),DATEView("constellation_Capricorn")};
    ...
    public static String getToday(Context ctx){

        android.icu.util.Calendar instance = android.icu.util.Calendar.getInstance();
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DATEView("constellation_date_format"));
