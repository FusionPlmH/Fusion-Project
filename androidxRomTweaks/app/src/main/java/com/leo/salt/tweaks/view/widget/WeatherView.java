...
import static com.leo.salt.tweaks.view.widget.DialogView.GlobaInfo;
...
public void UpdateWeather(){
  ...
  public String Weather(){
    ...
    public void onClick(View v) {
        ...
        try {
            applicationInfo = mContext.getPackageManager().getApplicationInfo("com.sec.android.daemonapp", 0);
        ...
        GlobaInfo(getContext(),appLabel,Weather(), SweetAlertDialog.CUSTOM_IMAGE_TYPE,true,appIcon);
    }
