...
.method public final decode(Lokio/BufferedSource;JLokio/BufferedSink;)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/http2/Huffman$Node;->getChildren()[Lokhttp3/internal/http2/Huffman$Node;
    ...
    invoke-virtual {v4}, Lokhttp3/internal/http2/Huffman$Node;->getSymbol()I

    move-result v7

    invoke-interface {p4, v7}, Lokio/BufferedSink;->writeByte(I)Lokio/BufferedSink;

    invoke-virtual {v4}, Lokhttp3/internal/http2/Huffman$Node;->getTerminalBitCount()I

    move-result v4

    sub-int/2addr v0, v4

    sget-object v4, Lokhttp3/internal/http2/Huffman;->root:Lokhttp3/internal/http2/Huffman$Node;
