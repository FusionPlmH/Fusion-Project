.class public final Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices;
...
.method public constructor <init>(Lcom/leo/salt/tools/constants/BackupRestoreUnit;)V
    ...
    iput-object p1, p0, Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices;->this$0:Lcom/leo/salt/tools/constants/BackupRestoreUnit;
...
.method public run()V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices;->this$0:Lcom/leo/salt/tools/constants/BackupRestoreUnit;
    ...
    const-string v4, "getApksStringInt(R.string.edx_1)"
    ...
    invoke-virtual {v3}, Lcom/leo/salt/utils/Consts;->getMkdir()Ljava/lang/String;
    ...
    sget-object v4, Lcom/leo/salt/tweaks/updates/EdXposed;->unzipEdXposedPath:Ljava/lang/String;

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v4, "/EdXposed_Installer.apk"
    ...
    const-string v4, "/Riru_-_EdXposed-v0.4.5.1_YAHFA.zip /cache/recovery/Riru_-_EdXposed-v0.4.5.1_YAHFA.zip"
    ...
    iget-object v0, p0, Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices;->this$0:Lcom/leo/salt/tools/constants/BackupRestoreUnit;

    invoke-virtual {v0}, Lcom/leo/salt/tools/constants/BackupRestoreUnit;->HideProgressBar()V

    new-instance v0, Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices$run$1;

    invoke-direct {v0, p0}, Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices$run$1;-><init>(Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices;)V
    ...
    :goto_0
    invoke-virtual {v0}, Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices$run$1;->start()V
    ...
    :goto_2
    iget-object v1, p0, Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices;->this$0:Lcom/leo/salt/tools/constants/BackupRestoreUnit;

    invoke-virtual {v1}, Lcom/leo/salt/tools/constants/BackupRestoreUnit;->HideProgressBar()V

    new-instance v1, Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices$run$1;

    invoke-direct {v1, p0}, Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices$run$1;-><init>(Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices;)V

    invoke-virtual {v1}, Lcom/leo/salt/tools/constants/BackupRestoreUnit$EdXposedServices$run$1;->start()V
