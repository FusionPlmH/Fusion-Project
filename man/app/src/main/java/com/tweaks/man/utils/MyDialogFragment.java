...
public class MyDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private Dialog getRebootMenuDialog() {
        @SuppressLint("InflateParams") View view = LayoutInflater.from(new ContextThemeWrapper(LeoApp.getContext(), R.style.AppTheme)).inflate(R.layout.reboot_layout, null);
    ...
    public void onClick(View v) {
        int id = v.getId();
        PowerManager powerManager = (PowerManager)LeoApp.getContext().getSystemService(Context.POWER_SERVICE);
        switch (id) {
