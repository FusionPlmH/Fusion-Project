...
import com.tweaks.man.theme.ColorChooseDialog;
import com.tweaks.man.theme.ThemeControl;
import com.tweaks.man.utils.BackupRestoreIntentService;
import com.tweaks.man.utils.Constants;
import com.tweaks.man.utils.MyDialogFragment;
import com.tweaks.man.utils.SuTask;
...
public class MainActivity extends BaseActivity
        ...
        MyDialogFragment.OnDialogFragmentListener , ColorChooseDialog.IClickColorSelectCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(LeoApp.getContext(), "Leo 不咸的盐巴 编译 By Man-1993", Toast.LENGTH_SHORT).show();
        ...
        if (mNavMenuItemsIds.contains(id)) {
            ...
            switch (id) {
                ...
                case R.id.themes:
                    ...
                    dialog.show(this,getThemeUtils().getThemePosition());
                    break;
                case R.id.changeLog:
    ...
    public void onClickSelectCallback(int position, int color) {
       ...
       getThemeUtils().setTheme(ThemeControl.themeArr()[position]);
        getThemeUtils().setThemePosition(position);
        reload();
