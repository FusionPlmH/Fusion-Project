package com.tweaks.man.utils;

import android.os.Environment;

import com.tweaks.man.LeoApp;
...
public class Constants {
    ...
    static final String BACKUP_FOLDER_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "Man1993" + File.separator + "Backups";
    ...
    static final String SHARED_PREFS_FOLDER_PATH = LeoApp.getContext().getFilesDir().getParent() + File.separator + "shared_prefs";
    ...
    public static final String SERVICE_INTENT_ACTION_BACKUP = "com.man.action.BACKUP";
    public static final String SERVICE_INTENT_ACTION_RESTORE = "com.man.action.RESTORE";
