...
import com.tweaks.man.prefs.OpenAppPreference;
import com.tweaks.man.prefs.UriSelectionPreference;
...
public class PrefsFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener,
    ...
    public boolean onPreferenceClick(Preference preference) {
        if (((PreferenceScreen) preference).getPreferenceCount() > 0) {
            ...
            if(LeoApp.getContext().getPackageManager().resolveActivity(preference.getIntent(), 0) != null) {
