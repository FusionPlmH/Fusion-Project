...
import com.tweaks.leo.utils.Utils;
...
public class MySeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public MySeekBarPreference(Context context, AttributeSet attrs) {
        ...
        mPopup=typedArray.getBoolean(R.styleable.MySeekBarPreference_showPopup, true);
    ...
    protected void onBindView(View view) {
        ...
        maxText.setText(getContext().getResources().getString(R.string.seek_bar_max)+": "+String.format(Locale.getDefault(), mFormat, mMaxValue, mUnitValue));
        minText.setText(getContext().getResources().getString(R.string.seek_bar_min)+": "+String.format(Locale.getDefault(), mFormat, mMinValue, mUnitValue));
        mValueText.setText(getContext().getResources().getString(R.string.seek_bar_present)+": "+String.format(Locale.getDefault(), mFormat, getPersistedInt(mMaxValue / 2), mUnitValue));
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        mValueText.setText(getContext().getResources().getString(R.string.seek_bar_present)+": "+String.format(Locale.getDefault(), mFormat, updatedProgress, mUnitValue));
        if(mPopup) {
            vTxtPopup.setText(String.format(Locale.getDefault(), mFormat, updatedProgress, mUnitValue));
        }
    }
