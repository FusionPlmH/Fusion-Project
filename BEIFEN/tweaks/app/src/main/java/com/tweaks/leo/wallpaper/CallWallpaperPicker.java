...
public class CallWallpaperPicker extends WallpaperPicker
        {
            String StringKey = WALLPAPER_URL("leo_activity_wallpaper");
  ...
  public void WallpaperUse()  throws IOException{
        ...
        try {
            ...
            String string =  Settings.System.getString(getActivity().getContentResolver(), "leo_tweaks_activity_wallpaper");
            if (string != null) {
            ...
            Settings.System.putString(getActivity().getContentResolver(), "leo_tweaks_activity_wallpaper", this. StringKey);
        } finally {
