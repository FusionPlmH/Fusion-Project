 ...
 private Context mContext;
    ...
    public boolean onPreferenceChange(Preference preference,  Object newValue) {
        ...
        if(preference == mPulldownBackgroundFormat){
            if(newValue.equals("666")){
                ...
                intentFragment.putExtra(SubActivity.KEY_TYPE, SubActivity.FragmentType.NotificationPanelWallpaperPicker);
    ...
    public void ResetColor() {
        Settings.System.putInt(getActivity().getContentResolver(),
                "leo_tweaks_qspanel_bg_only_color", Color.parseColor("#fffafafa"));
        Settings.System.putInt(getActivity().getContentResolver(),
                "leo_tweaks_qspanel_gradient_bg_one_color", Color.parseColor("#fffafafa"));
        Settings.System.putInt(getActivity().getContentResolver(),
                "leo_tweaks_qspanel_gradient_bg_two_color", Color.parseColor("#fffafafa"));
        Settings.System.putInt(getActivity().getContentResolver(),
                "leo_tweaks_qspanel_gradient_bg_three_color", Color.parseColor("#fffafafa"));
        Settings.System.putInt(getActivity().getContentResolver(),
                "leo_tweaks_qspanel_bg_stroke_color", Color.parseColor("#FF00BCD4"));
        Settings.System.putInt(getActivity().getContentResolver(),
                "leo_tweaks_qspanel_bg_wallpaper_color", Color.parseColor("#FFFFFFFF"));
    }
}
