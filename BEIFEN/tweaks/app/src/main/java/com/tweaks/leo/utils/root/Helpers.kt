...
import com.tweaks.leo.utils.Constants.safety
       ...
       /* fun Mount(mount: Int) {
            when (mount) {
                ...
                //    RootUtils.runCommand("mount -o rw,remount /system")
                    // 挂载system
                    KeepShellSync.doCmdSync("mount -o rw,remount /cache")
                 ...
                 //   RootUtils.runCommand("mkdir /cache/recovery")
                    // 挂载system
                    KeepShellSync.doCmdSync("cp  /system/leo/dolby/command /cache/recovery/command")
              //      RootUtils.runCommand("cp  /system/leo/dolby/command /cache/recovery/command")
                ...
                6 -> RootUtils.runCommand("cp  /system/leo/update/command /cache/recovery/command")
            }
        }


       */ fun OtaCode(name: String, context: Context, chip: String) {
        ...
        fun ClearOTA() {
            KeepShellSync.doCmdSync("rm -r /data/data/com.tweaks.leo/app_textures")
            KeepShellSync.doCmdSync("rm -r /data/data/com.tweaks.leo/cache")
            KeepShellSync.doCmdSync("rm -r /data/data/com.tweaks.leo/app_webview")
            KeepShellSync.doCmdSync("rm -r /sdcard/Download/SamsungQualcomm_update.zip")
            KeepShellSync.doCmdSync("rm -r /sdcard/Download/SamsungExynos_update.zip")
        }
