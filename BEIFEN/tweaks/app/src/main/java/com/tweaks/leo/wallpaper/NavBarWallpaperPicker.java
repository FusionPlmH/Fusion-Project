...
public class NavBarWallpaperPicker extends WallpaperPicker {

    String StringKey = WALLPAPER_URL("leo_navbar_bg_wallpaper");
    ...
    public void WallpaperUse()  throws IOException{
        ...
        try {
            ...
            String string =  Settings.System.getString(getActivity().getContentResolver(), "leo_tweaks_navbar_bg_wallpaper");
            if (string != null) {
            ...
            Settings.System.putString(getActivity().getContentResolver(), "leo_tweaks_navbar_bg_wallpaper", this. StringKey);
        } finally {
