...
public class BackupRestoreIntentService extends IntentService {
    ...
    private class LocalReceiver extends BroadcastReceiver {
        static final String BACKUP_COMPLETE_ACTION = "com.leo.action.BACKUP_COMPLETE";
        static final String RESTORE_COMPLETE_ACTION = "com.leo.action.RESTORE_COMPLETE";
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (intent.getAction()) {
                ...
                case RESTORE_COMPLETE_ACTION:
                    ...
                    Intent startMainActivity = new Intent(context, SubActivity.class);
