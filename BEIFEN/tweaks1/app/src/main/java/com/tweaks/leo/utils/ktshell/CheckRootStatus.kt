...
import com.tweaks.leo.utils.root.Helpers.executeCommandWithOutput
    ...
    companion object {
        ...
        fun grantPermission(context: Context) {
            ...
            if (!checkPermission(context, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                cmds.append("pm grant com.tweaks.leo android.permission.READ_EXTERNAL_STORAGE;\n")
            }
            if (!checkPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                cmds.append("pm grant com.tweaks.leo android.permission.WRITE_EXTERNAL_STORAGE;\n")
            }
            if (!checkPermission(context, Manifest.permission.CHANGE_CONFIGURATION)) {
                cmds.append("pm grant com.tweaks.leo android.permission.CHANGE_CONFIGURATION;\n")
            }
            if (!checkPermission(context, Manifest.permission.WRITE_SECURE_SETTINGS)) {
                cmds.append("pm grant com.tweaks.leo android.permission.WRITE_SECURE_SETTINGS;\n")
            }
