...
public class QSWallpaperPicker extends WallpaperPicker {





    //String StringKey = ("/data/data/com.tweaks.leo/wallpaper/leo_qspanel_bg_wallpaper_" + WALLPAPER_DATE + WALLPAPER_format);

  String StringKey =WALLPAPER_URL("leo_qspanel_bg_wallpaper") ;
    ...
    public void WallpaperUse()  throws IOException{
        ...
        try {
            ...
            String string =  Settings.System.getString(getActivity().getContentResolver(), "leo_tweaks_qspanel_bg_wallpaper");
            if (string != null) {
            ...
            Settings.System.putString(getActivity().getContentResolver(), "leo_tweaks_qspanel_bg_wallpaper", this. StringKey);
        } finally {
