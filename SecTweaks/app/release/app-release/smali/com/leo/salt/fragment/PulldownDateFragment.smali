...
# static fields
.field private static final DATE_FORMAT:Ljava/lang/String; = "leo_date_format"

.field private static final STATUS_BAR_CLOCK_DATE_FORMAT:Ljava/lang/String; = "leo_tweaks_pulldown_date_format"
...
.method private parseDateFormats()V
    ...
    const-string v6, "leo_tweaks_pulldown_date_format"
    ...
    :cond_3
    iget-object v0, p0, Lcom/leo/salt/fragment/PulldownDateFragment;->mDateFormat:Lcom/leo/salt/preference/MyListPreference;
...
.method public disablePreferences()V
    ...
    invoke-virtual {p0}, Lcom/leo/salt/fragment/PulldownDateFragment;->getPreferenceManager()Landroid/preference/PreferenceManager;

    move-result-object v0

    const-string v2, "leo_tweaks_pulldown_lunar_font"
    ...
    const-string v2, "leo_tweaks_pulldown_lunar_visible"
    ...
    const-string v2, "leo_tweaks_pulldown_lunar_orientation"
    ...
    const-string v2, "leo_tweaks_pulldown_lunar_constellation"
    ...
    const-string v2, "leo_tweaks_pulldown_lunar_symbol"
    ...
    const-string v2, "leo_tweaks_pulldown_date_week_style"
    ...
    const-string v2, "leo_date_format"
    ...
    const-string v2, "leo_tweaks_pulldown_date_week_orientation"
    ...
    const-string v2, "leo_tweaks_pulldown_date_symbol"
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/leo/salt/fragment/PulldownDateFragment;->mResolver:Landroid/content/ContentResolver;
    ...
    invoke-virtual {p0, p1, p0, v0}, Lcom/leo/salt/fragment/PulldownDateFragment;->BasePreferenceFragment(Landroid/content/Context;Landroid/preference/PreferenceFragment;Ljava/lang/String;)V

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Lcom/leo/salt/fragment/PulldownDateFragment;->setHasOptionsMenu(Z)V

    const-string p1, "leo_date_format"

    invoke-virtual {p0, p1}, Lcom/leo/salt/fragment/PulldownDateFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object p1

    check-cast p1, Lcom/leo/salt/preference/MyListPreference;

    iput-object p1, p0, Lcom/leo/salt/fragment/PulldownDateFragment;->mDateFormat:Lcom/leo/salt/preference/MyListPreference;

    invoke-direct {p0}, Lcom/leo/salt/fragment/PulldownDateFragment;->parseDateFormats()V

    iget-object p1, p0, Lcom/leo/salt/fragment/PulldownDateFragment;->mResolver:Landroid/content/ContentResolver;

    const-string v0, "leo_tweaks_pulldown_date_format"
    ...
    iget-object p1, p0, Lcom/leo/salt/fragment/PulldownDateFragment;->mDateFormat:Lcom/leo/salt/preference/MyListPreference;
    ...
    invoke-virtual {p0, p1}, Lcom/leo/salt/fragment/PulldownDateFragment;->isProKeyInstalled(Landroid/content/Context;)Z

    move-result p1

    if-nez p1, :cond_2

    invoke-virtual {p0}, Lcom/leo/salt/fragment/PulldownDateFragment;->disablePreferences()V
...
.method public onPause()V
    ...
    invoke-virtual {p0}, Lcom/leo/salt/fragment/PulldownDateFragment;->onPauseFragment()V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    const-string v1, "leo_tweaks_pulldown_date_format"
    ...
    iget-object p2, p0, Lcom/leo/salt/fragment/PulldownDateFragment;->mDateFormat:Lcom/leo/salt/preference/MyListPreference;
...
.method public onResume()V
    ...
    invoke-virtual {p0}, Lcom/leo/salt/fragment/PulldownDateFragment;->onResumeFragment()V
