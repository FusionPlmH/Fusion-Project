...
import com.leo.salt.fragment.TaskOthersFragment;
...
public class RecentsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.list_grid_recents);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        Utils.StatusBarColor(this);
        getFragmentManager().beginTransaction().replace(R.id.fragment_container, new TaskOthersFragment()).commit();
    }
