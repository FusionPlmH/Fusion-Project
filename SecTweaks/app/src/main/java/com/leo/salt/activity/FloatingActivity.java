...
public class FloatingActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.list_grid_floating);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        Utils.StatusBarColor(this);
        getFragmentManager().beginTransaction().replace(R.id.fragment_container, new FloatingFragment()).commit();
    }
