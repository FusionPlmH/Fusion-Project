...
import com.leo.salt.fragment.TaskBackgroundWallpaperFragment;
import com.leo.salt.fragment.TaskOthersFragment;


public class RecentsTabLayoutFragment extends Fragment {
    ...
    private static final int[] mFragments = new int[] {
			...
			R.string.recents_tabs,
            R.string.list_grid_background


    };

    public RecentsTabLayoutFragment() {
    }
    ...
    private static class TabAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
               return new TaskOthersFragment();
                case 1:
                return new TaskBackgroundWallpaperFragment();
            }
            return null;
