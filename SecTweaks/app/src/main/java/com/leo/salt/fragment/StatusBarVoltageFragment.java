...
public class StatusBarVoltageFragment extends BasePreferenceFragment {

    @Override
    public void onCreate(Bundle savedInstanceState ) {
        super.onCreate(savedInstanceState);
      //  addPreferencesFromResource(R.xml.statusbar_voltage_prefs);
        BasePreferenceFragment(mContext, this, "statusbar_voltage_prefs");
