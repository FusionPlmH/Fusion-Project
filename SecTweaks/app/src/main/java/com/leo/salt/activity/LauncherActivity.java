...
import com.leo.salt.fragment.FloatingFragment;
import com.leo.salt.fragment.LauncherBackgroundWallpaperFragment;
import com.leo.salt.kt.ImgFragment;
import com.leo.salt.theme.Utils;
import com.leo.salt.ui.RecentsTabLayoutFragment;
...
public class LauncherActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.list_grid_launcher);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        Utils.StatusBarColor(this);
        getFragmentManager().beginTransaction().replace(R.id.fragment_container, new LauncherBackgroundWallpaperFragment()).commit();
    }
