...
public class ManageAutostartsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.assist_grid_autostart);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        Utils.StatusBarColor(this);
        getFragmentManager().beginTransaction().replace(R.id.fragment_container, new ManageAutostarts()).commit();
    }
