...
public class DownloadService extends Service {
    ...
    private DownloadListener listener=new DownloadListener() {
        ...
        public void onProgress(int progress) {
            ...
            //这样就可以在状态栏看到下载进度了
            getNotificationManager().notify(1,getNotification(getApplicationContext().getResources().getString(R.string.process_download)+getRomName(),progress));
        }
        ...
        public  void main() {
            ...
            file.renameTo(new File(OTApath));
             file = new File(OTAURL+Hitomi_ROM_OTAZIP);
            //将原文件更改为f:\a\b.xlsx，其中路径是必要的。注意
            file.renameTo(new File(OTApath));
        }
       // Handler handler;
