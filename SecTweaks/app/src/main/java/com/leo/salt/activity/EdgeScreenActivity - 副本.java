...
import com.leo.salt.fragment.EdgeScreen;
...
public class EdgeScreenActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.edge_single_plus_name);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        Utils.StatusBarColor(this);
     
            getFragmentManager().beginTransaction().replace(R.id.fragment_container, new EdgeScreen()).commit();
