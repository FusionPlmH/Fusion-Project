package com.leo.global.utils.kotlin;
...
import com.leo.global.utils.AppInfo
import com.leo.global.utils.Build.executeCommandWithOutput
import com.leo.global.utils.Constants.APP_HIDE_HISTORY_SPF
import com.leo.global.utils.kotlin.Consts.AbsBackUpDir
import com.leo.global.utils.kotlin.Consts.MountSystemRW
import com.leo.global.utils.kotlin.Consts.PACKAGE_NAME
...
open class DialogAppOptions(protected final var context: Context, protected var apps: ArrayList<AppInfo>, protected var handler: Handler) {
        ...
        AlertDialog.Builder(context).setTitle("请选择操作")
                ...
                .setItems(
                        arrayOf(context.getString(R.string.app_manage_backup_apk_data),
                                ...
                                context.getString(R.string.app_manage_freeze_apk),
                                context.getString(R.string.app_manage_unfreeze_apk),
    ...
    protected fun checkRestoreData(): Boolean {
        val r = executeCommandWithOutput(false, "cd $userdataPath/${PACKAGE_NAME};echo `toybox ls -ld|cut -f3 -d ' '`; echo `ls -ld|cut -f3 -d ' '`;")
