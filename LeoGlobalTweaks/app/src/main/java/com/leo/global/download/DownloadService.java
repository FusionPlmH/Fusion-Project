...
import static com.leo.global.download.DownloadCons.OTAZIP;
import static com.leo.global.download.DownloadCons.OTApath;
...
public class DownloadService extends Service {
    ...
    private DownloadListener listener=new DownloadListener() {
        ...
        public void onProgress(int progress) {
            ...
            //这样就可以在状态栏看到下载进度了
            getNotificationManager().notify(1,getNotification(getApplicationContext().getResources().getString(R.string.process_download)+"LEO",progress));
        }
       ...
       // Handler handler;
        ...
        public void onFailed() {
            ...
            Toast.makeText(DownloadService.this,srt,Toast.LENGTH_SHORT).show();
