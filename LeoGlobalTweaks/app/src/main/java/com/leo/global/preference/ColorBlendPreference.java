...
import com.leo.global.colorpicker.CircleColorDrawable;
import com.leo.global.tweaks.R;

import net.margaritov.preference.colorpicker.ColorPickerDialog;

import static com.leo.global.utils.PrefUtils.getBlendColorForPercent;
    ...
    private void updatePreview() {
        if (mViewColorStart != null) {
           mViewColorStart.setBackgroundColor(mColorStart);
            //mViewColorStart.setBackground(new CircleColorDrawable(getBlendColorForPercent(mColorEnd, mColorStart, mBlendReverse, 50)));
        }
        if (mViewColorEnd != null) {
           mViewColorEnd.setBackgroundColor(mColorEnd);
            //mViewColorEnd.setBackground(new CircleColorDrawable(getBlendColorForPercent(mColorEnd, mColorStart, mBlendReverse, 50)));
        }
        if (mViewColorBetween != null) {
           // mViewColorBetween.setBackground(new CircleColorDrawable(getBlendColorForPercent(mColorEnd, mColorStart, mBlendReverse, 50)));
