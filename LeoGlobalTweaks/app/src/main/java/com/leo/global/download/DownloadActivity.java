...
import static com.leo.global.download.DownloadCons.DownloadRoute;
import static com.leo.global.download.DownloadCons.DownloadRoute2;
import static com.leo.global.download.DownloadCons.LEO_ROMOTAUS_LING;

import static com.leo.global.download.DownloadCons.LeoOTAHTTP;
import static com.leo.global.download.DownloadCons.OtaUrl;
...
import static com.leo.global.utils.NetUtils.hasNetWork;
import static com.leo.global.view.widget.DialogView.initSafetyDialogView;


public class DownloadActivity extends BaseCollapsingToolbarActivity implements View.OnClickListener {
...
//                    }
            ...
            mAppBarLayout.addOnOffsetChangedListener(new AppBarStateChangeListener() {
                ...
                public void onStateChanged(AppBarLayout appBarLayout, State state) {
                    if( state == State.EXPANDED ) {
                        ...
                        mCollapsingLinearLayout.setVisibility(View.VISIBLE);
                        CollapsingToolbarLayoutSubText.setText(getLeoBuild("ro.build.display.id"));
    ...
    public  void  OTA() {
        if(getLeoSafety().equals(safety)){
            ...
            initSafetyDialogView(mContext,true);
          //  showSnack(R.string.no_donate_sumarry);
        }
    ...
    public  void  getDownload() {
        final String items[] = {this.getResources().getString(R.string.ota_update_url),this.getResources().getString(R.string.ota_update_url_2)};
        AlertDialog dialog = new AlertDialog.Builder(this)
                .setTitle(R.string.ota_update_system)//设置对话框的标题
                .setItems(items, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        int otanull=R.string.no_ota;
                        switch (which) {
                            case 0:  //线路1
                                downloadBinder.startDownload(DownloadRoute(mContext,otanull));//LEO线路1

                                break;
                            case 1://线路2
                                downloadBinder.startDownload(DownloadRoute2(mContext,otanull));//LEO线路1
                                break;
                        }
                        dialog.dismiss();
                    }
