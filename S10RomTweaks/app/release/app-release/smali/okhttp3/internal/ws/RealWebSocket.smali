...
.method public final writeOneFrame$okhttp()Z
    ...
    iget-object v5, p0, Lokhttp3/internal/ws/RealWebSocket;->pongQueue:Ljava/util/ArrayDeque;
    ...
    iget-object v4, p0, Lokhttp3/internal/ws/RealWebSocket;->receivedCloseReason:Ljava/lang/String;
    ...
    :cond_3
    new-instance v6, Lokhttp3/internal/ws/RealWebSocket$CancelRunnable;

    invoke-direct {v6, p0}, Lokhttp3/internal/ws/RealWebSocket$CancelRunnable;-><init>(Lokhttp3/internal/ws/RealWebSocket;)V
    ...
    iput-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->cancelFuture:Ljava/util/concurrent/ScheduledFuture;
    :try_end_1
    ...
    :cond_7
    invoke-virtual {v3, v5}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lokio/ByteString;)V

    goto :goto_1

    :cond_8
    instance-of v0, v7, Lokhttp3/internal/ws/RealWebSocket$Message;
    ...
    invoke-virtual {v7}, Lokhttp3/internal/ws/RealWebSocket$Message;->getFormatOpcode()I
    ...
    invoke-virtual {v3, v1, v4, v5}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lokio/Sink;
    ...
    invoke-interface {v1, v0}, Lokio/BufferedSink;->write(Lokio/ByteString;)Lokio/BufferedSink;
    ...
    :cond_a
    instance-of v0, v7, Lokhttp3/internal/ws/RealWebSocket$Close;
    ...
    :cond_b
    invoke-virtual {v7}, Lokhttp3/internal/ws/RealWebSocket$Close;->getCode()I

    move-result v0

    invoke-virtual {v7}, Lokhttp3/internal/ws/RealWebSocket$Close;->getReason()Lokio/ByteString;

    move-result-object v5

    invoke-virtual {v3, v0, v5}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILokio/ByteString;)V
    ...
    :cond_c
    invoke-virtual {v0, v3, v1, v4}, Lokhttp3/WebSocketListener;->onClosed(Lokhttp3/WebSocket;ILjava/lang/String;)V
    :try_end_5
