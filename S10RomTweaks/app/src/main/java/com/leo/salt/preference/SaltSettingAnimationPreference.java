...
public class SaltSettingAnimationPreference extends SaltSettingDefaultListPreference implements Preference.OnPreferenceChangeListener{
    private List<CharSequence> mEntries, mValues;
    private static final String TAG = "SaltSettingAnimationPreference";

    public SaltSettingAnimationPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        intV(context);
    }
