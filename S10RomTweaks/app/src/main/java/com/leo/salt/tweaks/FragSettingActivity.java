...
import com.leo.salt.gridView.CarrierTabLayoutFragment;
import com.leo.salt.gridView.QSClockTabLayoutFragment;
import com.leo.salt.gridView.QSbuttonTabLayoutFragment;
import com.leo.salt.gridView.SystemTabLayoutFragment;
import com.leo.salt.gridView.UIBGTabLayoutFragment;
...
public class FragSettingActivity extends BaseSettingActivity {
    ...
    private Fragment getFragmentByType(FragmentType type){
        ...
        switch (type){
            ...
            case  StatusBarBG:
                fragment = new UIBGTabLayoutFragment();
                break;
