...
public class UserNotificationActivity extends BaseActivity  {
   ...
   public TextView mName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle(getApksStringInt(R.string.user_inform));
        intView();
    ...
    public String data = "";
    public String CN= "inform_cn";
    public String EN = "inform_en";
    ...
    protected Void doInBackground(Void... voids) {
         try {
             ...
             for(int i=0;i<jsonArray.length();i++){
                 ...
                 Carnumber = object.getString("Date");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            for(int i=0;i<CarNumber_list2.size();i++){
                mName.append("\n");
                mName.append(CarNumber_list.get(i));
