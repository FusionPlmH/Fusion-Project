...
public class SaltSettingMultipleChoicePreference extends DialogPreference {
    ...
    public SaltSettingMultipleChoicePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        TypedArray generalTypedArray = context.obtainStyledAttributes(attrs, R.styleable.LeoPreference);

        mReverseDependencyKey = generalTypedArray.getString(R.styleable.LeoPreference_reverseDependency);
