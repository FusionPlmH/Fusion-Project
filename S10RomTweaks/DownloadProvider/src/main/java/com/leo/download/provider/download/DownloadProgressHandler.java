package com.leo.download.provider.download;
...
import com.leo.download.provider.data.DownloadData;
import com.leo.download.provider.db.Db;

import java.io.File;

import static com.leo.download.provider.data.Consts.CANCEL;
import static com.leo.download.provider.data.Consts.DESTROY;
import static com.leo.download.provider.data.Consts.ERROR;
import static com.leo.download.provider.data.Consts.FINISH;
import static com.leo.download.provider.data.Consts.NONE;
import static com.leo.download.provider.data.Consts.PAUSE;
import static com.leo.download.provider.data.Consts.PROGRESS;
import static com.leo.download.provider.data.Consts.START;
