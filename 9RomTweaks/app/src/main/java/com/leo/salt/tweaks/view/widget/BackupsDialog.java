...
public class BackupsDialog extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        switch (mRequestCode) {
            case BACKUP_OR_RESTORE_DIALOG_REQUEST_CODE:
                return getBackupRestoreChooserDialog();
            case RESTORE_FILE_SELECTOR_DIALOG_REQUEST_CODE:
    ...
    private Dialog getBackupRestoreChooserDialog() {
        ...
        return new AlertDialog.Builder(getActivity())
                .setTitle(LeoAmberApplication.getContext().getResources().getString(R.string.app_name)+" "+ LeoAmberApplication.getContext().getResources().getString(R.string.backup_restore_dialog_title))
