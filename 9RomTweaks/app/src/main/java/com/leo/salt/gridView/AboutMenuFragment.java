            ...
            switch (position) {
                ...
                case 3:
                    ...
                    if(getLeoBuild("ro.hardware").equals("qcom")){
                        str=getLeoBuild("ro.product.model")+"/CHC";
                    }else {
                        if(getLeoBuild("ro.product.model").equals("SM-G9750")){
                            str="SM-G975F"+"/DBT";
                        }else if(getLeoBuild("ro.product.model").equals("SM-G9730")){
                            str="SM-G975F"+"/DBT";
                        }else {
                            str=getLeoBuild("ro.product.model")+"/DBT";
                        }
    ...
    public class GridViewItemOnClick implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            switch (position) {
                ...
                case 2:// 关机
                    String str;
                    if(getLeoBuild("ro.leo.ota.code").equals("Qualcomm_S9")){
                        str="q7gpzu9GUYM-Qz9mMVS95LxXR8JxI4xG";
                    }else if(getLeoBuild("ro.leo.ota.code").equals("Exynos_S9")){
                        str="q7gpzu9GUYM-Qz9mMVS95LxXR8JxI4xG";
                    }else {
                        str="4zUqpP7ZnFnqswJGwuTDkCbK6zxOZp-5";
                    }
                    joinQQGroup(mContext,str);
                    break;
                case 3:// 关机
