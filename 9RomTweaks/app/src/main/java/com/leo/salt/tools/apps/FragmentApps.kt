...
import android.view.*
import com.leo.salt.tools.constants.*
import com.leo.salt.tools.constants.KeepShellPublic.doCmdSync


import com.leo.salt.tweaks.R
import com.leo.salt.tweaks.resource.Resource
import com.leo.salt.tweaks.resource.Resource.DonatePermission
import com.leo.salt.tweaks.view.widget.DialogView.SafetyDonateDialogView
...
class FragmentApps : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        if (DonatePermission()) {
            ...
            SafetyDonateDialogView(activity)
        }
    ...
    private fun showHideAppDialog() {
        ...
        AlertDialog.Builder(context).setTitle(AppsTextView("apps_hide_record"))
